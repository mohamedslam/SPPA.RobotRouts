...
{
    public abstract class StiDataRelationCheck : StiCheck
    {
        #region Fields
        ...
        public override StiCheckObjectType ObjectType
        {
            get
            {
                return StiCheckObjectType.DataRelation;
            }
        }
        ...
        public override string ElementName
        {
            get
            {
                if (Element == null)
                    return null;
                return ((StiDataRelation)Element).Name;
            }
        }
        #endregion
        ...
        public override void CreatePreviewImage(out Image elementImage, out Image highlightedElementImage, bool useScale = false)
        {
            ...
            var dataRelation = this.Element as StiDataRelation;

            var treeView = new TreeView();
            treeView.BeforeExpand += new TreeViewCancelEventHandler(TreeNode_Expand);
            treeView.BeforeCollapse += new TreeViewCancelEventHandler(TreeNode_Collapsed);
            ...
            dataBuilder.Build(treeView.Nodes, dataRelation.Dictionary, true, true);

            Rectangle treeNodeBounds = Rectangle.Empty;
            TreeNode dataNode = GetTreeNode(treeView.Nodes);
            if (dataNode != null)
            {
        ...
        #region TreeNode.Collapsed&Expanded
