...
{
    public class StiSourcesInAbsentDataRelationCheck : StiDataRelationCheck
    {
        #region Properties
        ...
        public override string ShortMessage
        {
            get
            {
                return string.Format(StiLocalizationExt.Get("CheckDataRelation", "StiSourcesInAbsentDataRelationCheckShort"), this.ElementName);
            }
        }
        ...
        public override string LongMessage
        {
            get
            {
                return string.Format(StiLocalizationExt.Get("CheckDataRelation", "StiSourcesInAbsentDataRelationCheckLong"), this.ElementName);
            }
        }
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            {
                StiSourcesInAbsentDataRelationCheck check = new StiSourcesInAbsentDataRelationCheck();
