...
{
    public class StiDuplicatedNameCheck : StiReportCheck
    {
        #region Properties
        ...
        public override string LongMessage => 
            string.Format(StiLocalizationExt.Get("CheckReport", IsDataSource ? "StiDuplicatedName2CheckLong" : "StiDuplicatedNameCheckLong"), this.ElementName);
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            Hashtable hash = report.ScriptLanguage == StiReportLanguageType.VB ? new Hashtable(StringComparer.InvariantCultureIgnoreCase) : new Hashtable();
