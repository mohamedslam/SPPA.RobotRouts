...
{
    public class StiTotalPageCountDoublePassCheck : StiReportCheck
    {
        #region Properties
        ...
        public override string LongMessage => 
            StiLocalizationExt.Get("CheckComponent", "StiTotalPageCountDoublePassCheckLong");
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            if (failed)
            {
                var check = new StiTotalPageCountDoublePassCheck();
                check.Element = obj;
