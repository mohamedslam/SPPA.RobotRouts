...
{
    public class StiReportEventsAtInterpretationCheck : StiReportCheck
    {
        #region Properties
        public override bool PreviewVisible => false;

        public override string ShortMessage => 
            StiLocalizationExt.Get("CheckComponent", "StiEventsAtInterpretationCheckShort");

        public override string LongMessage => 
            string.Format(StiLocalizationExt.Get("CheckComponent", "StiEventsAtInterpretationCheckLong"), EventName, ElementName);
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            return new StiReportEventsAtInterpretationCheck
            {
                Element = obj,
                EventName = str
            };
