...
{
    public class StiCountDataDataSourceAtDataBandCheck : StiComponentCheck
    {
        #region Properties
        ...
        public override string LongMessage
        {
            get
            {
                return string.Format(StiLocalizationExt.Get("CheckComponent", "StiCountDataDataSourceAtDataBandLong"), this.ElementName);
            }
        }
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            try
            {
                ...
                if (failed)
                {
                    StiCountDataDataSourceAtDataBandCheck check = new StiCountDataDataSourceAtDataBandCheck();
                    check.Element = obj;
                    return check;
                }
                else return null;
