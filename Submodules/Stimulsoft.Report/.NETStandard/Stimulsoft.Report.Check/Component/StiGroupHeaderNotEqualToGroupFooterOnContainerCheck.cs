...
{
    public class StiGroupHeaderNotEqualToGroupFooterOnContainerCheck : StiComponentCheck
    {
        #region Properties
        ...
        public override string LongMessage
        {
            get
            {
                return string.Format(StiLocalizationExt.Get("CheckComponent", "StiGroupHeaderNotEqualToGroupFooterOnContainerLong"), this.ElementName);
            }
        }
        ...
        private bool Check()
        {
            ...
            if (container != null)
            {
                ...
                {
                    if (container.Components[index] is StiGroupHeaderBand)
                    {
                        countGroupHeader++;
                    }
                    else if (container.Components[index] is StiGroupFooterBand)
                    {
                        countGroupFooter++;
                    }
                }
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            try
            {
                ...
                if (failed)
                {
                    StiGroupHeaderNotEqualToGroupFooterOnContainerCheck check = new StiGroupHeaderNotEqualToGroupFooterOnContainerCheck();
                    check.Element = obj;
                    return check;
                }
                else return null;
