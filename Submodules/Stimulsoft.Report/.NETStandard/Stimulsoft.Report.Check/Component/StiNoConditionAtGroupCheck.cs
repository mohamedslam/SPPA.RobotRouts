...
{
    public class StiNoConditionAtGroupCheck : StiComponentCheck
    {
        #region Properties
        ...
        public override string LongMessage
        {
            get
            {
                return string.Format(StiLocalizationExt.Get("CheckComponent", "StiNoConditionAtGroupCheckLong"), this.ElementName);
            }
        }
        ...
        private bool Check()
        {
            if (Element is IStiGroup)
            {
                if (string.IsNullOrEmpty(((IStiGroup)Element).Condition.Value))
                    return true;
            }
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            try
            {
                ...
                if (failed)
                {
                    StiNoConditionAtGroupCheck check = new StiNoConditionAtGroupCheck();
                    check.Element = obj;
