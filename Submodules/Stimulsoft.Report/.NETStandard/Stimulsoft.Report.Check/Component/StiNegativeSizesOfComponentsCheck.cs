...
{
    public class StiNegativeSizesOfComponentsCheck : StiComponentCheck
    {
        #region Properties
        ...
        public override string LongMessage
        {
            get
            {
                return string.Format(StiLocalizationExt.Get("CheckComponent", "StiNegativeSizesOfComponentsCheckLong"), this.ElementName);
            }
        }
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            try
            {
                ...
                if (failed)
                {
                    StiNegativeSizesOfComponentsCheck check = new StiNegativeSizesOfComponentsCheck();
                    check.Element = obj;
