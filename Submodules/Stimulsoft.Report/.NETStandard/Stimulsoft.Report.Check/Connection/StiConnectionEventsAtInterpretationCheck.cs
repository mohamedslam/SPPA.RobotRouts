...
{
    public class StiConnectionEventsAtInterpretationCheck : StiConnectionCheck
    {
        #region Properties
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            if (!(Element is StiDatabase) || (report.CalculationMode != StiCalculationMode.Interpretation && !StiOptions.Engine.ForceInterpretationMode))
                return null;

            var database = Element as StiDatabase;
            ...
            return new StiConnectionEventsAtInterpretationCheck
            {
                Element = obj,
                EventName = str
            };
