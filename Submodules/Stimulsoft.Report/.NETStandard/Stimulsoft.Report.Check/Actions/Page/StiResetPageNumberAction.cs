...
{
    public class StiResetPageNumberAction : StiAction
    {
        public override string Name => StiLocalizationExt.Get("CheckActions", "Off");

        public override string Description => StiLocalizationExt.Get("CheckActions", "StiResetPageNumberActionLong");
        ...
        public override void Invoke(StiReport report, object element, string elementName)
        {
            ...
            if (element is StiPage)
                ((StiPage)element).ResetPageNumber = false;
