...
{
    public class StiPrintOnPreviousPageCheck2 : StiPageCheck
    {
        #region Properties
        public override string ShortMessage => 
            StiLocalizationExt.Get("CheckComponent", "StiPrintOnPreviousPageCheck2Short");

        public override string LongMessage => 
            string.Format(StiLocalizationExt.Get("CheckComponent", "StiPrintOnPreviousPageCheck2Long"), Element);
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            if (failed)
            {
                StiPrintOnPreviousPageCheck2 check = new StiPrintOnPreviousPageCheck2();
                check.Element = obj;
                return check;
            }
            else return null;
