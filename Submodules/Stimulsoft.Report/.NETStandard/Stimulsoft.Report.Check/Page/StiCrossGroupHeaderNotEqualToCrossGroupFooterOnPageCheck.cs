...
{
    public class StiCrossGroupHeaderNotEqualToCrossGroupFooterOnPageCheck : StiPageCheck
    {
        #region Properties
        ...
        public override string LongMessage => 
            string.Format(StiLocalizationExt.Get("CheckComponent", "StiCrossGroupHeaderNotEqualToCrossGroupFooterOnPageLong"), this.ElementName);
        ...
        private bool Check()
        {
            ...
            if (page != null && !(page is IStiForm))
            {
                ...
                {
                    if (page.Components[index] is StiCrossGroupHeaderBand)
                    {
                        countCrossGroupHeader++;
                    }
                    else if (page.Components[index] is StiCrossGroupFooterBand)
                    {
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            try
            {
                ...
                if (failed)
                {
                    StiCrossGroupHeaderNotEqualToCrossGroupFooterOnPageCheck check = new StiCrossGroupHeaderNotEqualToCrossGroupFooterOnPageCheck();
                    check.Element = obj;
                    return check;
                }
                else return null;
