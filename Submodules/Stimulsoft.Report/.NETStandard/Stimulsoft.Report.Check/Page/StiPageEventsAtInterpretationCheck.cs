...
{
    public class StiPageEventsAtInterpretationCheck : StiPageCheck
    {
        #region Properties
        ...
        public override object ProcessCheck(StiReport report, object obj)
        {
            ...
            if (!(Element is StiPage) || (report.CalculationMode != StiCalculationMode.Interpretation && !StiOptions.Engine.ForceInterpretationMode))
                return null;
            ...
            return new StiPageEventsAtInterpretationCheck
            {
                Element = obj,
                EventName = str
            };
