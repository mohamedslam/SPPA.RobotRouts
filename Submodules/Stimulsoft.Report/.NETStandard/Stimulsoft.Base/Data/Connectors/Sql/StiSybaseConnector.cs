...
namespace Stimulsoft.Base
{
    public class StiSybaseConnector : StiSqlDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.SybaseDataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.SybaseDataSource;

        public override string Name => "Sybase";
        ...
        /// </summary>
        public override string[] NuGetPackages => new string[] { "Sybase.AdoNet.AseClient.dll" };

        /// <summary>
        /// Gets the package version for this connector.
        /// </summary>
        public override string NuGetVersion => "1.0.0";
        #endregion
        ...
        {
            return StiDataOptions.SampleConnectionString.Sybase;
        }
        #endregion
        ...
        {
            this.NameAssembly = "Sybase.AdoNet.AseClient.dll";
