...
namespace Stimulsoft.Base
{
    public class StiVistaDbConnector : StiSqlDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.VistaDbDataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.VistaDbDataSource;

        public override string Name => "VistaDB";

        /// <summary>
        /// Gets the type of an enumeration which describes data types.
        /// </summary>
        public override Type SqlType => typeof(StiDbType.VistaDb);

        /// <summary>
        /// Gets the default value of the data parameter.
        /// </summary>
        public override int DefaultSqlType => (int)StiDbType.VistaDb.VarChar;
        #endregion
            ...
            try
            {
                using (var connection = CreateConnection())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var table = StiDataTableSchema.NewView(row.TABLE_NAME, this);
                    ...
                    try
                    {
                        ...
                        {
                            var table = StiDataTableSchema.NewProcedure(row.SPECIFIC_NAME, this);
        ...
        public override int GetSqlType(Type type)
        {
            if (type == typeof(DateTime)) 
                return (int)StiDbType.VistaDb.Date;

            if (type == typeof(TimeSpan)) 
                return (int)StiDbType.VistaDb.Timestamp;

            if (type == typeof(Int64)) 
                return (int)StiDbType.VistaDb.BigInt;

            if (type == typeof(Int32)) 
                return (int)StiDbType.VistaDb.Int;

            if (type == typeof(Int16)) 
                return (int)StiDbType.VistaDb.SmallInt;

            if (type == typeof(SByte)) 
                return (int)StiDbType.VistaDb.TinyInt;
            ...
            if (type == typeof(Single)) 
                return (int)StiDbType.VistaDb.Float;

            if (type == typeof(Double)) 
                return (int)StiDbType.VistaDb.Real;

            if (type == typeof(Decimal)) 
                return (int)StiDbType.VistaDb.Decimal;

            if (type == typeof(String)) 
                return (int)StiDbType.VistaDb.VarChar;

            if (type == typeof(Boolean)) 
                return (int)StiDbType.VistaDb.Bit;

            if (type == typeof(Char)) 
                return (int)StiDbType.VistaDb.VarChar;

            if (type == typeof(Byte[])) 
                return (int)StiDbType.VistaDb.Binary;
        ...
        {
            return StiDataOptions.SampleConnectionString.VistaDb;
        }
        #endregion
