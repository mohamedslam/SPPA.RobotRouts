...
namespace Stimulsoft.Base
{
    public class StiUniversalDevartConnector : StiSqlDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.UniversalDevartDataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.UniversalDevartDataSource;

        public override string Name => "Universal (dotConnect)";

        /// <summary>
        /// Gets the type of an enumeration which describes data types.
        /// </summary>
        public override Type SqlType => typeof(StiDbType.Universal);

        /// <summary>
        /// Gets the default value of the data parameter.
        /// </summary>
        public override int DefaultSqlType => (int)StiDbType.Universal.VarChar;
        #endregion
        ...
        public override StiDataSchema RetrieveSchema(bool allowException = false)
        {
            ...
            try
            {
                using (var connection = CreateConnection())
                {
                    ...
                    try
                    {
                        var tables = GetSchema(connection, "Tables", restrictions);
        ...
        public override int GetSqlType(Type type)
        {
            if (type == typeof(DateTime)) 
                return (int)StiDbType.Universal.Date;

            if (type == typeof(TimeSpan)) 
                return (int)StiDbType.Universal.TimeStamp;

            if (type == typeof(Int64)) 
                return (int)StiDbType.Universal.BigInt;

            if (type == typeof(Int32)) 
                return (int)StiDbType.Universal.Int;

            if (type == typeof(Int16)) 
                return (int)StiDbType.Universal.SmallInt;

            if (type == typeof(SByte)) 
                return (int)StiDbType.Universal.Byte;
            ...
            if (type == typeof(Single)) 
                return (int)StiDbType.Universal.Double;

            if (type == typeof(Double)) 
                return (int)StiDbType.Universal.Double;

            if (type == typeof(Decimal)) 
                return (int)StiDbType.Universal.Decimal;
            ...
            if (type == typeof(Byte[])) 
                return (int)StiDbType.Universal.Blob;
        ...
        {
            return StiDataOptions.SampleConnectionString.UniversalDevart;
        }
        #endregion
