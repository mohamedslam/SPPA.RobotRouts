...
namespace Stimulsoft.Base
{
    public class StiInformixConnector : StiSqlDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.InformixDataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.InformixDataSource;

        public override string Name => "Informix";

        /// <summary>
        /// Gets the type of an enumeration which describes data types.
        /// </summary>
        public override Type SqlType => typeof(StiDbType.Informix);

        /// <summary>
        /// Gets the default value of the data parameter.
        /// </summary>
        public override int DefaultSqlType => (int)StiDbType.Informix.Text;
        #endregion
        ...
        public override int GetSqlType(Type type)
        {
            if (type == typeof(DateTime)) 
                return (int)StiDbType.Informix.Date;

            if (type == typeof(Int64)) 
                return (int)StiDbType.Informix.BigInt;

            if (type == typeof(Int32))
                return (int)StiDbType.Informix.Integer;

            if (type == typeof(Int16))
                return (int)StiDbType.Informix.SmallInt;
            ...
            if (type == typeof(Single)) 
                return (int)StiDbType.Informix.Float;

            if (type == typeof(Double)) 
                return (int)StiDbType.Informix.Double;

            if (type == typeof(Decimal)) 
                return (int)StiDbType.Informix.Decimal;
            ...
            if (type == typeof(Char)) 
                return (int)StiDbType.Informix.Char;

            if (type == typeof(Byte[])) 
                return (int)StiDbType.Informix.Binary;
        ...
        {
            return StiDataOptions.SampleConnectionString.Informix;
        }
        #endregion
