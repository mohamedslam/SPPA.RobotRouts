...
namespace Stimulsoft.Base
{
    public class StiDb2Connector : StiSqlDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.Db2DataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.Db2DataSource;

        public override string Name => "DB2";

        /// <summary>
        /// Gets the type of an enumeration which describes data types.
        /// </summary>
        public override Type SqlType => typeof(StiDbType.Db2);

        /// <summary>
        /// Gets the default value of the data parameter.
        /// </summary>
        public override int DefaultSqlType => (int)StiDbType.Db2.VarChar;

        /// <summary>
        /// Gets the package identificator for this connector.
        /// </summary>
        public override string[] NuGetPackages => new string[] { "IBM.Data.DB2" };

        /// <summary>
        /// Gets the package version for this connector.
        /// </summary>
        public override string NuGetVersion => "10.0.5.5";
        #endregion
        ...
        public override int GetSqlType(Type type)
        {
            if (type == typeof(DateTime)) 
                return (int)StiDbType.Db2.Date;

            if (type == typeof(TimeSpan)) 
                return (int)StiDbType.Db2.Timestamp;

            if (type == typeof(Int64)) 
                return (int)StiDbType.Db2.BigInt;

            if (type == typeof(Int32))
                return (int)StiDbType.Db2.Integer;

            if (type == typeof(Int16)) 
                return (int)StiDbType.Db2.SmallInt;

            if (type == typeof(SByte)) 
                return (int)StiDbType.Db2.Byte;
            ...
            if (type == typeof(Single)) 
                return (int)StiDbType.Db2.Double;

            if (type == typeof(Double)) 
                return (int)StiDbType.Db2.Double;

            if (type == typeof(Decimal)) 
                return (int)StiDbType.Db2.Decimal;
        ...
        {
            return StiDataOptions.SampleConnectionString.Db2;
        }
        #endregion
