...
namespace Stimulsoft.Base
{
    public class StiSqlCeConnector : StiSqlDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.SqlCeDataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.SqlCeDataSource;

        public override string Name => "SQL CE";

        /// <summary>
        /// Gets the type of an enumeration which describes data types.
        /// </summary>
        public override Type SqlType => typeof(StiDbType.SqlCe);

        /// <summary>
        /// Gets the default value of the data parameter.
        /// </summary>
        public override int DefaultSqlType => (int)StiDbType.SqlCe.VarChar;
        #endregion
        ...
        public override int GetSqlType(Type type)
        {
            if (type == typeof(DateTime)) 
                return (int)StiDbType.SqlCe.DateTime;

            if (type == typeof(DateTimeOffset)) 
                return (int)StiDbType.SqlCe.DateTimeOffset;

            if (type == typeof(TimeSpan)) 
                return (int)StiDbType.SqlCe.BigInt;
            ...
            if (type == typeof(Int16)) 
                return (int)StiDbType.SqlCe.SmallInt;
            ...
            if (type == typeof(Single)) 
                return (int)StiDbType.SqlCe.Float;

            if (type == typeof(Double)) 
                return (int)StiDbType.SqlCe.Real;

            if (type == typeof(Decimal)) 
                return (int)StiDbType.SqlCe.Decimal;
            ...
            if (type == typeof(Char)) 
                return (int)StiDbType.SqlCe.Char;

            if (type == typeof(Byte[])) 
                return (int)StiDbType.SqlCe.Binary;

            if (type == typeof(Guid)) 
                return (int)StiDbType.SqlCe.UniqueIdentifier;
        ...
        {
            return StiDataOptions.SampleConnectionString.SqlCe;
        }
        #endregion
