...
namespace Stimulsoft.Base
{
    public class StiTeradataConnector : StiSqlDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.TeradataDataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.TeradataDataSource;

        public override string Name => "Teradata";

        /// <summary>
        /// Gets the type of an enumeration which describes data types.
        /// </summary>
        public override Type SqlType => typeof(StiDbType.Teradata);

        /// <summary>
        /// Gets the default value of the data parameter.
        /// </summary>
        public override int DefaultSqlType => (int)StiDbType.Teradata.VarChar;
        #endregion
        ...
        /// <summary>
        /// Returns schema object which contains information about structure of the database. 
        /// Schema returned start at specified root element (if it applicable).
        /// </summary>
        public override StiDataSchema RetrieveSchema(bool allowException = false)
        {
            ...
            try
            {
                using (var connection = CreateConnection())
                {
                    ...
                    var tables = GetSchema(connection, "Tables", restrictionsArray);
                    ...
                    try
                    {
                        ...
                        var columns = GetSchema(connection, "Columns", colRestrictionsArray);
        ...
        public override int GetSqlType(Type type)
        {
            if (type == typeof(DateTime)) 
                return (int)StiDbType.Teradata.Date;

            if (type == typeof(TimeSpan)) 
                return (int)StiDbType.Teradata.Timestamp;

            if (type == typeof(Int64)) 
                return (int)StiDbType.Teradata.BigInt;

            if (type == typeof(Int32)) 
                return (int)StiDbType.Teradata.Integer;

            if (type == typeof(Int16)) 
                return (int)StiDbType.Teradata.SmallInt;

            if (type == typeof(SByte)) 
                return (int)StiDbType.Teradata.Byte;
            ...
            if (type == typeof(Single)) 
                return (int)StiDbType.Teradata.Double;

            if (type == typeof(Double)) 
                return (int)StiDbType.Teradata.Double;

            if (type == typeof(Decimal)) 
                return (int)StiDbType.Teradata.Decimal;
            ...
            if (type == typeof(Byte[])) 
                return (int)StiDbType.Teradata.Blob;
        ...
        {
            return StiDataOptions.SampleConnectionString.Teradata;
        }
        #endregion
