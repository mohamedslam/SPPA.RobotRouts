...
{
    public class StiCosmosSqlApiHelper
    {
        #region Fields
        ...
        {
            return StiDataOptions.SampleConnectionString.CosmosSql;
        }

        public object GetCosmosDbProvider()
        {
            return GetAssemblyData().CreateObject("Stimulsoft.Data.CosmosDB.StiCosmosDbSqlApiProvider", this.connectionString);
        }
        ...
        {
            var dataTable = GetDataTable(collectionName, $"SELECT TOP 1 * from {collectionName.Replace("-", "_")}" , 0, 1);
        ...
        public StiCosmosSqlApiHelper(string connectionString, string nugetVersion)
        {
