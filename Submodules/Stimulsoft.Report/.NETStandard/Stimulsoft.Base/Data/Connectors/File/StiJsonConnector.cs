...
namespace Stimulsoft.Base
{
    public class StiJsonConnector : StiFileDataConnector
    {
        ...
        /// </summary>
        public override StiConnectionIdent ConnectionIdent => StiConnectionIdent.JsonDataSource;

        /// <summary>
        /// Gets an order of the connector.
        /// </summary>
        public override StiConnectionOrder ConnectionOrder => StiConnectionOrder.JsonDataSource;
        ...
        /// </summary>
        public override StiFileType FileType => StiFileType.Json;
        #endregion
        ...
        public override DataSet GetDataSet(StiFileDataOptions options)
        {
            ...
            if (jsonOptions.Content == null || jsonOptions.Content.Length == 0)
                ...
                options.DataSet = StiBaseOptions.DefaultJsonConverterVersion == StiJsonConverterVersion.ConverterV2 
                    ? StiJsonToDataSetConverterV2.GetDataSet(jsonOptions.Content, jsonOptions.RelationDirection) 
                    : StiJsonToDataSetConverter.GetDataSet(jsonOptions.Content);
