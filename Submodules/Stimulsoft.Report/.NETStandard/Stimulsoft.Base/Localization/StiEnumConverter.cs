            ...
            if (value is string)
            {
                try
                {
                    ...
                    if (StiPropertyGridOptions.Localizable)
                    {
                        ...
                        {
                            var locName = StiLocalization.Get("PropertyEnum", Type.Name + str, false);
            ...
            object value, Type destinationType)
        {
            ...
            if ((destinationType == typeof(string)) && (value != null))
            {
                ...
                if (StiPropertyGridOptions.Localizable)
                {
                    if (name.IndexOf(',') == -1)
                    {
                        var locName = StiLocalization.Get("PropertyEnum", Type.Name + name, false);
                        return locName ?? name;
                    }
                    ...
                    foreach (string nm in names)
                    {
                        ...
                        var locName = StiLocalization.Get("PropertyEnum", Type.Name + nm.Trim(), false);
