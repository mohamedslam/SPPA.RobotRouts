...
namespace Stimulsoft.Base.Serializing
{
	...
	public enum StiSerializeTypes 
	{
        ...
        /// <summary>
        /// Serialize for all variations except code
        /// </summary>
        SerializeToAllExceptCode = SerializeToDesigner | SerializeToSaveLoad | SerializeToDocument,
		/// <summary>
		/// Serialize for all variations except document
		/// </summary>
		SerializeToAllExceptDocument = SerializeToDesigner | SerializeToSaveLoad | SerializeToCode
	}
	#endregion
	...
	public enum StiSerializationVisibility 
	{
		...
		Reference,
        /// <summary>
        /// Serialize as a reference to a control.
        /// </summary>
        Control
	}
	#endregion
