...
namespace Stimulsoft.Base.Drawing
{
	...
	/// </summary>
	public static class StiBrushes
	{
		#region Properties
	    /// <summary>
		/// Gets a defined Brush object with a Content color.
		/// </summary>
		public static Brush Content { get; } = new SolidBrush(StiColors.Content);
        
	    /// <summary>
		/// Gets a defined Brush object with a Dark Content color.
		/// </summary>
		public static Brush ContentDark { get; } = new SolidBrush(StiColors.ContentDark);
        
	    /// <summary>
		/// Gets a defined Brush object with a Focus color.
		/// </summary>
		public static Brush Focus { get; } = new SolidBrush(StiColors.Focus);
        
	    /// <summary>
		/// Gets a defined Brush object with the Selected color.
		/// </summary>
		public static Brush Selected { get; } = new SolidBrush(StiColors.Selected);

	    /// <summary>
		/// Gets a defined Brush object with the SelectedText color.
		/// </summary>
		public static Brush SelectedText { get; } = new SolidBrush(StiColors.SelectedText);

	    /// <summary>
		/// Gets a defined Brush object with the SelectedText color.
		/// </summary>
		public static Brush Window { get; } = new SolidBrush(SystemColors.Window);
	    #endregion
		...
		/// </summary>
		public static HatchStyle[] HatchStyles { get; } =
		{
