...
{
    public class StiGoogleChinaMapProvider : 
        StiGoogleMapProviderBase
    {
        public StiGoogleChinaMapProvider()
        {
        ...
        public override StiGeoMapProviderType ProviderType => StiGeoMapProviderType.GoogleChina;
        #endregion
        ...
        private string MakeTileImageUrl(StiGisPoint pos, int zoom)
        {
            ...
            return string.Format(urlFormat, urlFormatServer, GetServerNum(pos, 4), urlFormatRequest, StiGisGoogleProviderHelper.GoogleChinaMapVersion, chinaLanguage, pos.X, sec1, pos.Y, zoom, sec2, ServerChina);
        }
        #endregion
    }
}