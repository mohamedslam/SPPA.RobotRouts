...
namespace Stimulsoft.Map.Gis.Providers
{
    ...
    public sealed class StiOpenCycleMapProvider : 
        StiOpenStreetMapProviderBase
    {
        public StiOpenCycleMapProvider()
        {
        ...
        public override StiGeoMapProviderType ProviderType => StiGeoMapProviderType.OpenCycleMap;
        #endregion
