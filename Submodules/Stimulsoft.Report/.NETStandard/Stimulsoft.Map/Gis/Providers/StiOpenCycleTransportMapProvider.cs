...
namespace Stimulsoft.Map.Gis.Providers
{
    ...
    public sealed class StiOpenCycleTransportMapProvider : 
        StiOpenStreetMapProviderBase
    {
        public StiOpenCycleTransportMapProvider()
        {
        ...
        public override StiGeoMapProviderType ProviderType => StiGeoMapProviderType.OpenCycleMapTransport;
        #endregion
