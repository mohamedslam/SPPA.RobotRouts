...
{
    // http://www.mapy.cz/
    public sealed class StiCzechMapProvider : 
        StiCzechMapProviderBase
    {
        #region Fields
        private static readonly string UrlFormat = "http://m{0}.mapserver.mapy.cz/base-m/{1}-{2}-{3}";
        #endregion

        #region Properties
        public override StiGeoMapProviderType ProviderType => StiGeoMapProviderType.Czech;
        #endregion
