...
namespace Stimulsoft.Report.Web
{
    ...
    internal class JSON
    {
        ...
        protected static bool SerializeValue(object value, StringBuilder builder)
        {
            ...
            else if (value is Hashtable) success = SerializeObject((Hashtable)value, builder);
            ...
            else if (value is Enum || value is TimeSpan || value is DateTime) success = SerializeString(value.ToString(), builder);
#if NETSTANDARD
            else if (value is Microsoft.Extensions.Primitives.StringValues) success = SerializeString(value.ToString(), builder);
#endif
            else if (value is ValueType) success = SerializeNumber(Convert.ToDouble(value), builder);
