...
(function (root, factory) {
  ...
  Blockly.registry.Type.METRICS_MANAGER = new Blockly.registry.Type(
    "metricsManager"
  );
  ...
  Blockly.registry.unregister = function (a, b) {
    ...
    c && c[b]
      ...
      : console.warn(
          "Unable to unregister [" + b + "][" + a + "] from the registry."
        );
  };
  ...
  Blockly.Events.filter = function (a, b) {
    ...
    for (var c = [], d = Object.create(null), e = 0, f; (f = a[e]); e++)
      if (!f.isNull()) {
        var g = [
            f.isUiEvent ? Blockly.Events.UI : f.type,
            f.blockId,
            f.workspaceId,
          ].join(" "),
          h = d[g],
        ...
        if (!h) (d[g] = { event: f, index: e }), c.push(f);
          ...
          f.type != Blockly.Events.CLICK ||
          k.type != Blockly.Events.BUBBLE_OPEN
        )
      ...
      if (c) {
        ...
        try {
          ...
          if (d && d.isEnabled()) {
            ...
            (c.outputConnection || c.previousConnection) &&
            !b.isDragging()
          ) {
            do c.setEnabled(!1), (c = c.getNextBlock());
            while (c);
          }
        } finally {
  ...
  Blockly.Xml.blockToDom = function (a, b) {
    ...
    for (d = 0; (e = a.inputList[d]); d++) {
      ...
      if (e.type != Blockly.inputTypes.DUMMY) {
        ...
        e.type == Blockly.inputTypes.VALUE
          ? (h = Blockly.utils.xml.createElement("value"))
          : e.type == Blockly.inputTypes.STATEMENT &&
  ...
  Blockly.Xml.domToWorkspace = function (a, b) {
    ...
    Blockly.Events.fire(
      new (Blockly.Events.get(Blockly.Events.FINISHED_LOADING))(b)
    );
    return c;
  };
  ...
  Blockly.Xml.domToBlock = function (a, b) {
    ...
    if (Blockly.Events.isEnabled()) {
      ...
      for (f = 0; f < a.length; f++)
        (b = a[f]),
          Blockly.Events.fire(
            new (Blockly.Events.get(Blockly.Events.VAR_CREATE))(b)
          );
  ...
  Blockly.Xml.applyCommentTagNodes_ = function (a, b) {
    for (var c = 0, d; (d = a[c]); c++) {
      ...
      isNaN(g) ||
        isNaN(d) ||
        (b.commentModel.size = new Blockly.utils.Size(g, d));
      f &&
        b.getCommentIcon &&
        !b.isInFlyout &&
        setTimeout(function () {
  ...
  Blockly.Xml.findChildBlocks_ = function (a) {
    for (
      var b = { childBlockElement: null, childShadowElement: null }, c = 0, d;
      (d = a.childNodes[c]);
      c++
    )
      d.nodeType == Blockly.utils.dom.NodeType.ELEMENT_NODE &&
        ("block" == d.nodeName.toLowerCase()
          ? (b.childBlockElement = d)
          : "shadow" == d.nodeName.toLowerCase() && (b.childShadowElement = d));
    return b;
  };
  ...
  Blockly.Xml.domToBlockHeadless_ = function (a, b, c, d) {
    ...
    (b = a.getAttribute("disabled")) &&
      f.setEnabled("true" != b && "disabled" != b);
    ...
    if (b)
      switch (
        ...
        case "mutation":
          ...
          Blockly.Events.fire(
            new (Blockly.Events.get(Blockly.Events.CHANGE))(
              b,
              "mutation",
              null,
              c,
    ...
    if (c) {
      ...
      if (f) (e = c.getRelativeToSurfaceXY()), c.moveBy(f.x - e.x, f.y - e.y);
        ...
        if (e) {
          ...
          b == Blockly.connectionTypes.PREVIOUS_STATEMENT &&
            (g = a.nextConnection);
        g
          ? c.connect(g)
  ...
  Blockly.Events.Ui = function (a, b, c, d) {
    Blockly.Events.Ui.superClass_.constructor.call(
      this,
      a ? a.workspace.id : void 0
    );
  ...
  Blockly.Css.CONTENT = [
    ...
    //"background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px;",   //hide submenu icon
    "float: left;",
    "margin-left: -24px;",
    "position: static;",
    "}",
  ...
  Blockly.Themes.Classic.defaultBlockStyles = {
    colour_blocks: { colourPrimary: "#f3aa60" },
    list_blocks: { colourPrimary: "#ecc01c" },
    logic_blocks: { colourPrimary: "#91c854" },
    loop_blocks: { colourPrimary: "#aa0d43" },
    math_blocks: { colourPrimary: "#00948a" },
    procedure_blocks: { colourPrimary: "290" },
    text_blocks: { colourPrimary: "#9365b8" },
    variable_blocks: { colourPrimary: "330" },
    variable_dynamic_blocks: { colourPrimary: "#bf717f" },
  ...
  Blockly.ScrollbarPair.prototype.resize = function () {
    ...
    if (a) {
      ...
      this.oldHostMetrics_.absoluteLeft == a.absoluteLeft
        ? ((this.oldHostMetrics_ &&
            this.oldHostMetrics_.scrollWidth == a.scrollWidth &&
            this.oldHostMetrics_.viewLeft == a.viewLeft &&
            this.oldHostMetrics_.scrollLeft == a.scrollLeft) ||
            (b = !0),
          (this.oldHostMetrics_ &&
            this.oldHostMetrics_.scrollHeight == a.scrollHeight &&
            this.oldHostMetrics_.viewTop == a.viewTop &&
            this.oldHostMetrics_.scrollTop == a.scrollTop) ||
            (c = !0))
        : (c = b = !0);
      if (b || c) {
        try {
  ...
  Blockly.Scrollbar.prototype.constrainHandlePosition_ = function (a) {
    return (a =
      0 >= a || isNaN(a)
        ? 0
        : Math.min(a, this.scrollbarLength_ - this.handleLength_));
  };
  ...
  Blockly.Scrollbar.prototype.resizeViewHorizontal = function (a) {
    ...
    this.setPosition(
      ...
      a.absoluteTop +
        ...
        Blockly.Scrollbar.SCROLLBAR_MARGIN
    );
    this.resizeContentHorizontal(a);
  };
  ...
  Blockly.Scrollbar.prototype.resizeViewVertical = function (a) {
    ...
    this.setPosition(
      this.workspace_.RTL
        ? a.absoluteLeft + Blockly.Scrollbar.SCROLLBAR_MARGIN
        : a.absoluteLeft +
            a.viewWidth -
            Blockly.Scrollbar.scrollbarThickness -
            Blockly.Scrollbar.SCROLLBAR_MARGIN,
      a.absoluteTop + Blockly.Scrollbar.SCROLLBAR_MARGIN
    );
    this.resizeContentVertical(a);
  };
  ...
  Blockly.Tooltip.bindMouseEvents = function (a) {
    a.mouseOverWrapper_ = Blockly.browserEvents.bind(
      a,
      "mouseover",
      null,
      Blockly.Tooltip.onMouseOver_
    );
    a.mouseOutWrapper_ = Blockly.browserEvents.bind(
      a,
      "mouseout",
      null,
  ...
  Blockly.Tooltip.unbindMouseEvents = function (a) {
    a &&
      (Blockly.browserEvents.unbind(a.mouseOverWrapper_),
  ...
  Blockly.ASTNode.createConnectionNode = function (a) {
    if (!a) return null;
    var b = a.type;
    return b == Blockly.connectionTypes.INPUT_VALUE ||
      (b == Blockly.connectionTypes.NEXT_STATEMENT && a.getParentInput())
      ? Blockly.ASTNode.createInputNode(a.getParentInput())
      : b == Blockly.connectionTypes.NEXT_STATEMENT
      ? new Blockly.ASTNode(Blockly.ASTNode.types.NEXT, a)
      : b == Blockly.connectionTypes.OUTPUT_VALUE
  ...
  Blockly.Connection.prototype.connect_ = function (a) {
    ...
    if (b.isConnected()) {
      ...
      else if (b.type == Blockly.connectionTypes.INPUT_VALUE) {
    ...
    var l;
    Blockly.Events.isEnabled() &&
      (l = new (Blockly.Events.get(Blockly.Events.BLOCK_MOVE))(d));
  ...
  Blockly.Connection.prototype.isSuperior = function () {
    return (
      this.type == Blockly.connectionTypes.INPUT_VALUE ||
  ...
  Blockly.Connection.singleConnection_ = function (a, b) {
    ...
    for (var d = 0; d < a.inputList.length; d++) {
      ...
      if (
        e &&
        e.type == Blockly.connectionTypes.INPUT_VALUE &&
        f.canConnect(b, e, !1)
      ) {
        if (c) return null;
        c = e;
  ...
  Blockly.Connection.prototype.disconnectInternal_ = function (a, b) {
    var c;
    Blockly.Events.isEnabled() &&
      (c = new (Blockly.Events.get(Blockly.Events.BLOCK_MOVE))(b));
  ...
  Blockly.Events.BlockDrag = function (a, b, c) {
    Blockly.Events.BlockDrag.superClass_.constructor.call(
      this,
      a ? a.workspace.id : void 0
    );
    this.blockId = a ? a.id : null;
  ...
  Blockly.InsertionMarkerManager.prototype.hideInsertionMarker_ = function () {
    if (this.markerConnection_) {
      ...
      e =
        a.type == Blockly.connectionTypes.INPUT_VALUE &&
        !(e && e.targetConnection);
      !(a != c || (d && d.targetConnection)) || e
        ? a.targetBlock().unplug(!1)
        : a.type == Blockly.connectionTypes.NEXT_STATEMENT && a != c
  ...
  Blockly.BlockDragger.prototype.fireDragStartEvent_ = function () {
    var a = new (Blockly.Events.get(Blockly.Events.BLOCK_DRAG))(
      this.draggingBlock_,
      !0,
  ...
  Blockly.BlockDragger.prototype.fireMoveEvent_ = function () {
    var a = new (Blockly.Events.get(Blockly.Events.BLOCK_MOVE))(
      this.draggingBlock_
    );
  ...
  Blockly.VariableMap.prototype.renameVariableAndUses_ = function (a, b, c) {
    Blockly.Events.fire(
      new (Blockly.Events.get(Blockly.Events.VAR_RENAME))(a, b)
    );
    a.name = b;
  ...
  Blockly.VariableMap.prototype.deleteVariable = function (a) {
    for (var b = this.variableMap_[a.type], c = 0, d; (d = b[c]); c++)
      if (d.getId() == a.getId()) {
        b.splice(c, 1);
        Blockly.Events.fire(
          new (Blockly.Events.get(Blockly.Events.VAR_DELETE))(a)
        );
        break;
      }
  };
  ...
  Blockly.Bubble.prototype.getOverlap_ = function (a, b) {
    ...
    return Math.max(
      ...
      Math.min(
        1,
        ((Math.min(c + this.width_, b.left + b.width) - Math.max(c, b.left)) *
          (Math.min(a + this.height_, b.top + b.height) - Math.max(a, b.top))) /
  ...
  Blockly.Bubble.prototype.getOptimalRelativeLeft_ = function (a) {
    ...
    if (this.workspace_.RTL)
      var c = this.anchorXY_.x - b,
        ...
        e = a.left + a.width,
        f =
          a.left + Blockly.Scrollbar.scrollbarThickness / this.workspace_.scale;
    else
  ...
  Blockly.BubbleDragger.prototype.fireMoveEvent_ = function () {
    if (this.draggingBubble_.isComment) {
      var a = new (Blockly.Events.get(Blockly.Events.COMMENT_MOVE))(
  ...
  Blockly.Events.Click = function (a, b, c) {
    Blockly.Events.Click.superClass_.constructor.call(
      this,
      a ? a.workspace.id : b
    );
    this.blockId = a ? a.id : null;
  ...
  Blockly.Gesture.prototype.fireWorkspaceClick_ = function (a) {
    Blockly.Events.fire(
      new (Blockly.Events.get(Blockly.Events.CLICK))(null, a.id, "workspace")
    );
  };
  ...
  Blockly.Gesture.prototype.doBlockClick_ = function () {
    if (this.flyout_ && this.flyout_.autoClose)
      ...
      var a = new (Blockly.Events.get(Blockly.Events.CLICK))(
        this.startBlock_,
  ...
  Blockly.Field.prototype.updateMarkers_ = function () {
    ...
    a.keyboardAccessibilityMode &&
      this.markerSvg_ &&
      a.getMarker(Blockly.MarkerManager.LOCAL_MARKER).draw();
  };
  ...
  Blockly.Input.prototype.insertFieldAt = function (a, b, c) {
    ...
    if (!(b || ("" == b && c))) return a;
    "string" == typeof b &&
      (b = Blockly.fieldRegistry.fromJson({ type: "field_label", text: b }));
  ...
  Blockly.Block.prototype.getOnlyValueConnection_ = function () {
    for (var a = null, b = 0; b < this.inputList.length; b++) {
      ...
      if (
        c &&
        c.type == Blockly.connectionTypes.INPUT_VALUE &&
        c.targetConnection
      ) {
        if (a) return null;
        a = c;
  ...
  Blockly.Block.prototype.getFirstStatementConnection = function () {
    for (var a = 0, b; (b = this.inputList[a]); a++)
      if (
        b.connection &&
        b.connection.type == Blockly.connectionTypes.NEXT_STATEMENT
      )
        return b.connection;
    return null;
  };
  ...
  Blockly.Block.prototype.getInputsInline = function () {
    ...
    for (var a = 1; a < this.inputList.length; a++)
      if (
        this.inputList[a - 1].type == Blockly.inputTypes.DUMMY &&
        this.inputList[a].type == Blockly.inputTypes.DUMMY
      )
        return !1;
    for (a = 1; a < this.inputList.length; a++)
      if (
        this.inputList[a - 1].type == Blockly.inputTypes.VALUE &&
        this.inputList[a].type == Blockly.inputTypes.DUMMY
      )
        return !0;
    return !1;
  ...
  Blockly.Block.prototype.toString = function (a, b) {
    ...
    for (var g = Blockly.ASTNode.createBlockNode(this), h = g; g; ) {
      switch (g.getType()) {
        ...
        case Blockly.ASTNode.types.FIELD:
          (k = g.getLocation()),
            k.name != Blockly.constants.COLLAPSED_FIELD_NAME &&
              e.push(k.getText());
      }
      k = g;
      g = k.in() || k.next();
  ...
  Blockly.Block.prototype.validateTokens_ = function (a, b) {
    for (var c = [], d = 0, e = 0; e < a.length; e++) {
      ...
      if ("number" == typeof f) {
        if (1 > f || f > b)
          throw Error(
            'Block "' + this.type + '": Message index %' + f + " out of range."
          );
        if (c[f])
          throw Error(
            'Block "' + this.type + '": Message index %' + f + " duplicated."
          );
        c[f] = !0;
        d++;
      }
  ...
  Blockly.Block.prototype.interpolateArguments_ = function (a, b, c) {
    for (var d = [], e = 0; e < a.length; e++) {
      ...
      if ("string" == typeof f && ((f = this.stringToFieldJson_(f)), !f))
        continue;
      d.push(f);
    }
    (a = d.length) &&
      !this.isInputKeyword_(d[a - 1].type) &&
  ...
  Blockly.Block.prototype.fieldFromJson_ = function (a) {
    ...
    return !b && a.alt
      ? "string" == typeof a.alt
        ? (a = this.stringToFieldJson_(a.alt))
          ? this.fieldFromJson_(a)
          : null
        : this.fieldFromJson_(a.alt)
      : b;
  };
  ...
  Blockly.Block.prototype.removeInput = function (a, b) {
    for (var c = 0, d; (d = this.inputList[c]); c++)
      if (d.name == a)
        return (
          d.type == Blockly.inputTypes.STATEMENT && this.statementInputCount--,
          d.dispose(),
  ...
  Blockly.ContextMenu.callbackFactory = function (a, b) {
    return function () {
      ...
      Blockly.Events.isEnabled() &&
        !c.isShadow() &&
        Blockly.Events.fire(
          new (Blockly.Events.get(Blockly.Events.BLOCK_CREATE))(c)
        );
      c.select();
    };
  };
  ...
  Blockly.RenderedConnection.prototype.connect_ = function (a) {
    ...
    c &&
      d &&
      (this.type == Blockly.connectionTypes.NEXT_STATEMENT ||
      this.type == Blockly.connectionTypes.PREVIOUS_STATEMENT
        ? a.render()
        : b.render());
  ...
  Blockly.registry.register(
    Blockly.registry.Type.CURSOR,
    Blockly.BasicCursor.registrationName,
    Blockly.BasicCursor
  );
  ...
  Blockly.BlockSvg.prototype.unselect = function () {
    if (Blockly.selected == this) {
      var a = new (Blockly.Events.get(Blockly.Events.SELECTED))(
        this.id,
        null,
        this.workspace.id
      );
  ...
  Blockly.BlockSvg.prototype.updateCollapsed_ = function () {
    for (
      var a = this.isCollapsed(),
        b = Blockly.constants.COLLAPSED_INPUT_NAME,
        c = Blockly.constants.COLLAPSED_FIELD_NAME,
        d = 0,
        e;
      (e = this.inputList[d]);
      d++
  ...
  Blockly.BlockSvg.prototype.positionNearConnection = function (a, b) {
    (a.type != Blockly.connectionTypes.NEXT_STATEMENT &&
      a.type != Blockly.connectionTypes.INPUT_VALUE) ||
  ...
  Blockly.MetricsManager.prototype.getViewMetrics = function (a) {
    ...
    if (this.workspace_.getToolbox())
      if (
        e == Blockly.utils.toolbox.Position.TOP ||
        e == Blockly.utils.toolbox.Position.BOTTOM
      )
        b.height -= c.height;
      else {
        if (
          e == Blockly.utils.toolbox.Position.LEFT ||
          e == Blockly.utils.toolbox.Position.RIGHT
        )
          b.width -= c.width;
      }
  ...
  Blockly.FlyoutMetricsManager.prototype.getViewMetrics = function (a) {
    ...
    if (this.flyout_.horizontalLayout) {
      ...
      (c = b.width - this.flyout_.SCROLLBAR_PADDING),
  ...
  Blockly.PluginManager.prototype.addPlugin = function (a) {
    ...
    for (var b = 0, c; (c = a.types[b]); b++)
      (c = String(c).toLowerCase()),
        void 0 === this.typeToPluginIds_[c]
          ? (this.typeToPluginIds_[c] = [a.id])
          : this.typeToPluginIds_[c].push(a.id);
  };
  ...
  Blockly.PluginManager.Type.POSITIONABLE = new Blockly.PluginManager.Type(
    "positionable"
  );
  ...
  Blockly.WorkspaceSvg = function (a, b, c) {
    ...
    this.metricsManager_ = new (Blockly.registry.getClassFromOptions(
      Blockly.registry.Type.METRICS_MANAGER,
      a,
      !0
    ))(this);
  ...
  Blockly.WorkspaceSvg.prototype.setMetricsManager = function (a) {
    ...
    this.getMetrics = this.metricsManager_.getMetrics.bind(
  ...
  Blockly.WorkspaceSvg.prototype.refreshTheme = function () {
    ...
    var a = new (Blockly.Events.get(Blockly.Events.THEME_CHANGE))(
      this.getTheme().name,
      this.id
    );
    Blockly.Events.fire(a);
  ...
  Blockly.WorkspaceSvg.prototype.createDom = function (a) {
    ...
    (a = Blockly.registry.getClassFromOptions(
      Blockly.registry.Type.CURSOR,
      this.options
    )) && this.markerManager_.setCursor(new a());
  ...
  Blockly.WorkspaceSvg.prototype.addFlyout = function (a) {
    ...
    this.flyout_ = this.horizontalLayout
      ? new (Blockly.registry.getClassFromOptions(
  ...
  Blockly.WorkspaceSvg.prototype.resize = function () {
    ...
    for (
      var a = this.pluginManager_.getPlugins(
  ...
  Blockly.WorkspaceSvg.prototype.maybeFireViewportChangeEvent = function () {
    if (Blockly.Events.isEnabled()) {
      ...
      if (
        !(
          a == this.oldScale_ &&
          1 > Math.abs(b - this.oldTop_) &&
          1 > Math.abs(c - this.oldLeft_)
        )
      ) {
        var d = new (Blockly.Events.get(Blockly.Events.VIEWPORT_CHANGE))(
          b,
          c,
          a,
          this.id,
  ...
  Blockly.WorkspaceSvg.prototype.pasteBlock_ = function (a) {
          ...
          if (!a) {
            ...
            for (var l; (l = k[f]); f++)
              if (
                l.closest(
                  Blockly.SNAP_RADIUS,
                  new Blockly.utils.Coordinate(c, d)
                ).connection
              ) {
                a = !0;
                break;
    ...
    Blockly.Events.isEnabled() &&
      !b.isShadow() &&
      Blockly.Events.fire(
        new (Blockly.Events.get(Blockly.Events.BLOCK_CREATE))(b)
      );
    b.select();
  };
  ...
  Blockly.WorkspaceSvg.prototype.isMovableHorizontally = function () {
    ...
    return (
      this.isMovable() && (!a || (a && this.scrollbar.canScrollHorizontally()))
    );
  };
  Blockly.WorkspaceSvg.prototype.isMovableVertically = function () {
    var a = !!this.scrollbar;
    return (
      this.isMovable() && (!a || (a && this.scrollbar.canScrollVertically()))
    );
  };
  ...
  Blockly.WorkspaceSvg.prototype.getBlocksBoundingBox = function () {
    ...
    for (var b = a[0].getBoundingRectangle(), c = 1; c < a.length; c++) {
      var d = a[c];
      (d.isInsertionMarker && d.isInsertionMarker()) ||
        ((d = d.getBoundingRectangle()),
  ...
  Blockly.WorkspaceSvg.prototype.scroll = function (a, b) {
    ...
    this.scrollY = b;
    this.scrollbar &&
      this.scrollbar.set(-(a + c.scrollLeft), -(b + c.scrollTop), !1);
    a += c.absoluteLeft;
    b += c.absoluteTop;
    this.translate(a, b);
  };
  Blockly.WorkspaceSvg.setTopLevelWorkspaceMetrics_ = function (a) {
    var b = this.getMetrics();
    "number" == typeof a.x &&
      (this.scrollX = -(b.scrollLeft + (b.scrollWidth - b.viewWidth) * a.x));
    "number" == typeof a.y &&
      (this.scrollY = -(b.scrollTop + (b.scrollHeight - b.viewHeight) * a.y));
      ...
      if (c.hasFixedEdges && !a.isDragging())
        if (-1 !== Blockly.Events.BUMP_EVENTS.indexOf(b.type)) {
          ...
          if (d) {
            ...
            Blockly.bumpObjectIntoBounds_(a, c, d) &&
              !b.group &&
              console.warn(
          ...
          b.type === Blockly.Events.VIEWPORT_CHANGE &&
            b.scale > b.oldScale &&
  ...
  Blockly.bumpObjectIntoBounds_ = function (a, b, c) {
    ...
    return (a = Blockly.utils.math.clamp(g, d.left, b) - d.left) || f
      ? (c.moveBy(a, f), !0)
      : !1;
  };
  Blockly.init_ = function (a) {
    ...
    c = Blockly.browserEvents.conditionalBind(
      window,
      "resize",
      null,
      function () {
    ...
    b.moveOptions && b.moveOptions.scrollbars
      ? ((a.scrollbar = new Blockly.ScrollbarPair(
          a,
          !0 === b.moveOptions.scrollbars ||
  ...
  Blockly.inject.loadSounds_ = function (a, b) {
    ...
    d.push(
      Blockly.browserEvents.conditionalBind(document, "mousemove", null, a, !0)
    );
    d.push(
      Blockly.browserEvents.conditionalBind(document, "touchstart", null, a, !0)
    );
  };
  ...
  Blockly.Procedures.mutatorOpenListener = function (a) {
    if (
      a.type == Blockly.Events.BUBBLE_OPEN &&
      "mutator" === a.bubbleType &&
      a.isOpen
    ) {
  ...
  Blockly.ShortcutRegistry.prototype.addKeyMapping = function (a, b, c) {
    ...
    if (d && !c)
      throw Error(
        'Shortcut with name "' + b + '" collides with shortcuts ' + d.toString()
      );
  ...
  Blockly.ShortcutRegistry.prototype.removeKeyMapping = function (a, b, c) {
    ...
    if (!d && !c)
      return (
        console.warn(
          'No keyboard shortcut with name "' +
            b +
            '" registered with key code "' +
            a +
            '"'
        ),
        !1
    ...
    var e = d.indexOf(b);
    if (-1 < e)
      return d.splice(e, 1), 0 == d.length && delete this.keyMap_[a], !0;
    c ||
      console.warn(
        'No keyboard shortcut with name "' +
          b +
  ...
  Blockly.ShortcutRegistry.prototype.onKeyDown = function (a, b) {
    ...
    for (var d = 0, e; (e = c[d]); d++)
      if (
        ((e = this.registry_[e]),
        (!e.preconditionFn || e.preconditionFn(a)) &&
          e.callback &&
          e.callback(a, b, e))
      )
        return !0;
  ...
  Blockly.ShortcutRegistry.prototype.serializeKeyEvent_ = function (a) {
    ...
    "" != b && a.keyCode
      ? (b = b + "+" + a.keyCode)
      : a.keyCode && (b = a.keyCode.toString());
    return b;
  };
  Blockly.ShortcutRegistry.prototype.checkModifiers_ = function (a) {
    for (
      var b = Blockly.utils.object.values(
          Blockly.ShortcutRegistry.modifierKeys
        ),
        c = 0,
        d;
  ...
  Blockly.ShortcutRegistry.prototype.createSerializedKey = function (a, b) {
    ...
    if (b) {
      ...
      for (var d in Blockly.ShortcutRegistry.modifierKeys)
        -1 < b.indexOf(Blockly.ShortcutRegistry.modifierKeys[d]) &&
          ("" != c && (c += "+"), (c += d));
    }
  ...
  Blockly.VariableModel = function (a, b, c, d) {
    ...
    Blockly.Events.fire(
      new (Blockly.Events.get(Blockly.Events.VAR_CREATE))(this)
    );
  };
  ...
  Blockly.svgResize = function (a) {
    ...
    if (d) {
      ...
      d = d.offsetHeight;
      c.width != e &&
        (b.setAttribute("width", e + "px"), a.setCachedParentSvgSize(e, null));
      c.height != d &&
        (b.setAttribute("height", d + "px"), a.setCachedParentSvgSize(null, d));
      a.resize();
    }
  };
  ...
  Blockly.paste = function () {
    ...
    return Blockly.clipboardTypeCounts_ &&
  ...
  Blockly.Events.BubbleOpen = function (a, b, c) {
    Blockly.Events.BubbleOpen.superClass_.constructor.call(
      this,
      a ? a.workspace.id : void 0
    );
    this.blockId = a ? a.id : null;
  ...
  Blockly.Comment.prototype.createNonEditableBubble_ = function () {
    this.paragraphElement_ = Blockly.Bubble.textToDom(
      this.block_.getCommentText()
    );
    this.bubble_ = Blockly.Bubble.createNonEditableBubble(
      this.paragraphElement_,
      this.block_,
  ...
  Blockly.Flyout.prototype.positionAt_ = function (a, b, c, d) {
    ...
    if ((a = this.workspace_.scrollbar))
      a.setOrigin(c, d),
        a.resize(),
        a.hScroll &&
          a.hScroll.setPosition(a.hScroll.position.x, a.hScroll.position.y),
        a.vScroll &&
          a.vScroll.setPosition(a.vScroll.position.x, a.vScroll.position.y);
  };
  ...
  Blockly.Flyout.prototype.addBlockListeners_ = function (a, b, c) {
    ...
    this.listeners_.push(
      Blockly.browserEvents.bind(a, "mouseenter", b, b.addSelect)
    );
    this.listeners_.push(
      Blockly.browserEvents.bind(a, "mouseleave", b, b.removeSelect)
    );
    this.listeners_.push(
      Blockly.browserEvents.bind(c, "mouseenter", b, b.addSelect)
    );
    this.listeners_.push(
      Blockly.browserEvents.bind(c, "mouseleave", b, b.removeSelect)
    );
  };
  ...
  Blockly.Flyout.prototype.createBlock = function (a) {
    ...
    if (Blockly.Events.isEnabled()) {
      ...
      for (c = 0; c < a.length; c++) {
        var d = a[c];
        Blockly.Events.fire(
          new (Blockly.Events.get(Blockly.Events.VAR_CREATE))(d)
        );
      }
      Blockly.Events.fire(
        new (Blockly.Events.get(Blockly.Events.BLOCK_CREATE))(b)
  ...
  Blockly.HorizontalFlyout.prototype.getClientRect = function () {
    ...
    var a = this.svgGroup_.getBoundingClientRect(),
      b = a.top;
    return this.toolboxPosition_ == Blockly.utils.toolbox.Position.TOP
  ...
  Blockly.VerticalFlyout.prototype.getClientRect = function () {
    ...
    var a = this.svgGroup_.getBoundingClientRect(),
      b = a.left;
    return this.toolboxPosition_ == Blockly.utils.toolbox.Position.LEFT
    ...
    "string" == typeof a
      ...
      : (delete this.toolboxItemDef_.custom,
        (this.toolboxItemDef_.contents =
          Blockly.utils.toolbox.convertFlyoutDefToJsonArray(a)));
  ...
  Blockly.CollapsibleToolboxCategory.prototype.makeDefaultCssConfig_ =
    function () {
      var a =
        Blockly.CollapsibleToolboxCategory.superClass_.makeDefaultCssConfig_.call(
          this
        );
  ...
  Blockly.CollapsibleToolboxCategory.prototype.createSubCategoriesDom_ =
    function (a) {
      var b = document.createElement("div");
  ...
  Blockly.CollapsibleToolboxCategory.prototype.getChildToolboxItems =
    function () {
  ...
  Blockly.Events.ToolboxItemSelect.prototype.type =
  ...
  Blockly.Toolbox.prototype.attachEvents_ = function (a, b) {
    a = Blockly.browserEvents.conditionalBind(
      a,
      "click",
      this,
      this.onClick_,
    ...
    b = Blockly.browserEvents.conditionalBind(
      b,
      "keydown",
      this,
      this.onKeyDown_,
  ...
  Blockly.Toolbox.prototype.onKeyDown_ = function (a) {
    ...
    !b &&
      this.selectedItem_ &&
      this.selectedItem_.onKeyDown &&
      (b = this.selectedItem_.onKeyDown(a));
    b && a.preventDefault();
  };
      ...
      (this.horizontalLayout_
        ? ((b.style.left = "0"),
          ...
          this.toolboxPosition == Blockly.utils.toolbox.Position.TOP
            ? (b.style.top = "0")
            : (b.style.bottom = "0"))
        : (this.toolboxPosition == Blockly.utils.toolbox.Position.RIGHT
            ? (b.style.right = "0")
            : (b.style.left = "0"),
          (b.style.height = "100%"),
  ...
  Blockly.Toolbox.prototype.fireSelectEvent_ = function (a, b) {
    var c = a && a.getName(),
      d = b && b.getName();
    a == b && (d = null);
    a = new (Blockly.Events.get(Blockly.Events.TOOLBOX_ITEM_SELECT))(
      c,
      d,
      this.workspace_.id
    );
      ...
      this.workspace_.horizontalLayout
        ? ((a.toolboxPosition =
            ...
            Blockly.utils.toolbox.Position.TOP
              ? Blockly.utils.toolbox.Position.BOTTOM
              : Blockly.utils.toolbox.Position.TOP),
          (this.flyout = new (Blockly.registry.getClassFromOptions(
            Blockly.registry.Type.FLYOUTS_HORIZONTAL_TOOLBOX,
  ...
  Blockly.Trashcan.prototype.createDom = function () {
    ...
    Blockly.browserEvents.bind(
      ...
      "mousedown",
      this,
      this.blockMouseDownWhenOpenable_
    );
  ...
  Blockly.Trashcan.prototype.position = function (a, b) {
    if (this.verticalSpacing_) {
      this.left_ =
        a.toolboxMetrics.position == Blockly.utils.toolbox.Position.LEFT ||
      ...
      this.top_ = (a =
        a.toolboxMetrics.position !== Blockly.utils.toolbox.Position.BOTTOM)
        ? e
        : d;
      for (var f = this.getBoundingRectangle(), g = 0, h; (h = b[g]); g++)
        f.intersects(h) &&
          ((this.top_ = a
            ? h.top - c - this.MARGIN_BOTTOM_
            : h.bottom + this.MARGIN_BOTTOM_),
          (f = this.getBoundingRectangle()),
          (g = -1));
  ...
  Blockly.Trashcan.prototype.getBoundingRectangle = function () {
    return new Blockly.utils.Rect(
      this.top_,
      this.top_ + this.BODY_HEIGHT_ + this.LID_HEIGHT_,
      this.left_,
  ...
  Blockly.Trashcan.prototype.fireUiEvent_ = function (a) {
    a = new (Blockly.Events.get(Blockly.Events.TRASHCAN_OPEN))(
      a,
      this.workspace_.id
    );
    Blockly.Events.fire(a);
  ...
  Blockly.ZoomControls = function (a) {
    ...
    this.zoomResetGroup_ =
      ...
      this.zoomInGroup_ =
      this.verticalSpacing_ =
      this.onZoomOutWrapper_ =
      this.onZoomInWrapper_ =
      this.onZoomResetWrapper_ =
        null;
  };
  ...
  Blockly.ZoomControls.prototype.position = function (a, b) {
    if (this.verticalSpacing_) {
      ...
      for (var e = this.getBoundingRectangle(), f = 0, g; (g = b[f]); f++)
        e.intersects(g) &&
          ((this.top_ = a
            ? g.top - this.HEIGHT_ - this.MARGIN_BOTTOM_
            : g.bottom + this.MARGIN_BOTTOM_),
          (e = this.getBoundingRectangle()),
          (f = -1));
  ...
  Blockly.ZoomControls.prototype.createZoomResetSvg_ = function (a) {
    ...
    /*Blockly.utils.dom                //hide Zoom reset button
      .createSvgElement(
        Blockly.utils.Svg.IMAGE,
        {
          width: Blockly.SPRITE.width,
  ...
  Blockly.ZoomControls.prototype.resetZoom_ = function (a) {
    ...
    var b =
      Math.log(
        this.workspace_.options.zoomOptions.startScale / this.workspace_.scale
      ) / Math.log(this.workspace_.options.zoomOptions.scaleSpeed);
  ...
  Blockly.ShortcutItems.registerCopy = function () {
    ...
    Blockly.ShortcutRegistry.registry.register(a);
    var b = Blockly.ShortcutRegistry.registry.createSerializedKey(
      Blockly.utils.KeyCodes.C,
      [Blockly.utils.KeyCodes.CTRL]
    );
    Blockly.ShortcutRegistry.registry.addKeyMapping(b, a.name);
    b = Blockly.ShortcutRegistry.registry.createSerializedKey(
      Blockly.utils.KeyCodes.C,
  ...
  Blockly.ContextMenuItems.registerDeleteAll = function () {
    Blockly.ContextMenuRegistry.registry.register({
      displayText: function (a) {
        if (a.workspace)
          return (
            (a = Blockly.ContextMenuItems.getDeletableBlocks_(
              a.workspace
            ).length),
            1 == a
      ...
      preconditionFn: function (a) {
        ...
        if (!a.isInFlyout && a.isMovable() && !a.isCollapsed())
          for (var b = 1; b < a.inputList.length; b++)
            if (
              a.inputList[b - 1].type != Blockly.inputTypes.STATEMENT &&
              a.inputList[b].type != Blockly.inputTypes.STATEMENT
            )
              return "enabled";
        return "hidden";
      },
  ...
  Blockly.FieldAngle.prototype.dropdownCreate_ = function () {
    ...
    this.clickWrapper_ = Blockly.browserEvents.conditionalBind(
      a,
      "click",
      this,
      this.hide_
  ...
  Blockly.FieldMultilineInput.prototype.getDisplayText_ = function () {
    ...
    a = "";
    for (
      var c = this.isOverflowedY_ ? this.maxLines_ : b.length, d = 0;
      d < c;
      d++
    ) {
      var e = b[d];
      e.length > this.maxDisplayLength
        ? (e = e.substring(0, this.maxDisplayLength - 4) + "...")
        : this.isOverflowedY_ &&
          d === c - 1 &&
  ...
  Blockly.FieldMultilineInput.prototype.render_ = function () {
    ...
    this.isBeingEdited_ &&
      ((a = this.htmlInput_),
      this.isOverflowedY_
        ? Blockly.utils.dom.addClass(a, "blocklyHtmlTextAreaInputOverflowedY")
        : Blockly.utils.dom.removeClass(
            a,
  ...
  Blockly.FieldMultilineInput.prototype.updateSize_ = function () {
    ...
    if (this.isBeingEdited_) {
      ...
      for (d = 0; d < a.length; d++) {
        a[d].length > this.maxDisplayLength &&
          (a[d] = a[d].substring(0, this.maxDisplayLength));
        e.textContent = a[d];
  ...
  Blockly.FieldMultilineInput.prototype.setMaxLines = function (a) {
    "number" === typeof a &&
      0 < a &&
      a !== this.maxLines_ &&
      ((this.maxLines_ = a), this.forceRerender());
  };
  ...
  Blockly.Css.register(
    ".blocklyHtmlTextAreaInput {,font-family: monospace;,resize: none;,overflow: hidden;,height: 100%;,text-align: left;,},.blocklyHtmlTextAreaInputOverflowedY {,overflow-y: scroll;,}".split(
      ","
    )
  );
  Blockly.fieldRegistry.register(
  ...
  Blockly.blockRendering.RenderInfo.prototype.shouldStartNewRow_ = function (
    ...
    return b
      ? a.type == Blockly.inputTypes.STATEMENT ||
        b.type == Blockly.inputTypes.STATEMENT
        ? !0
        : a.type == Blockly.inputTypes.VALUE ||
          a.type == Blockly.inputTypes.DUMMY
        ? !this.isInline
  ...
  Blockly.blockRendering.RenderInfo.prototype.addAlignmentPadding_ = function (
    ...
    a.align == Blockly.constants.ALIGN.LEFT
      ? (d.width += b)
      : a.align == Blockly.constants.ALIGN.CENTRE
      ? ((c.width += b / 2), (d.width += b / 2))
      : a.align == Blockly.constants.ALIGN.RIGHT
      ? (c.width += b)
      : (d.width += b);
    a.width += b;
  };
  ...
  Blockly.blockRendering.Debug.prototype.drawRenderedElem = function (a, b) {
    if (Blockly.blockRendering.Debug.config.elems) {
      ...
      Blockly.blockRendering.Types.isField(a) &&
        a.field instanceof Blockly.FieldLabel &&
        this.debugElements_.push(
          Blockly.utils.dom.createSvgElement(
            Blockly.utils.Svg.RECT,
            {
    ...
    Blockly.blockRendering.Types.isInput(a) &&
      ...
      this.drawConnection(a.connectionModel);
  };
  Blockly.blockRendering.Debug.prototype.drawConnection = function (a) {
    if (Blockly.blockRendering.Debug.config.connections) {
      if (a.type == Blockly.connectionTypes.INPUT_VALUE) {
        ...
        a.type == Blockly.connectionTypes.OUTPUT_VALUE
          ? ((b = 2), (d = c = "magenta"))
          : a.type == Blockly.connectionTypes.NEXT_STATEMENT
          ? ((b = 4), (c = "goldenrod"), (d = "none"))
          : a.type == Blockly.connectionTypes.PREVIOUS_STATEMENT &&
            ((b = 2), (d = c = "goldenrod"));
      this.debugElements_.push(
        Blockly.utils.dom.createSvgElement(
          Blockly.utils.Svg.CIRCLE,
  ...
  Blockly.blockRendering.Debug.prototype.drawRenderedRow = function (a, b, c) {
    Blockly.blockRendering.Debug.config.rows &&
      (this.debugElements_.push(
        Blockly.utils.dom.createSvgElement(
          Blockly.utils.Svg.RECT,
          {
      ...
      Blockly.blockRendering.Types.isTopOrBottomRow(a) ||
    ...
    for (var d = 0, e = a.elements.length; d < e; d++) {
      ...
      f
        ? Blockly.blockRendering.Types.isSpacer(f)
          ? this.drawSpacerElem(f, a.height, c)
          : this.drawRenderedElem(f, c)
        : console.warn("A row has an undefined or null element.", a, f);
    }
  ...
  Blockly.blockRendering.Debug.prototype.drawDebug = function (a, b) {
    ...
    for (var c = 0, d = 0, e; (e = b.rows[d]); d++)
      Blockly.blockRendering.Types.isBetweenRowSpacer(e)
        ? this.drawSpacerRow(e, c, b.RTL)
        : this.drawRowWithElements(e, c, b.RTL),
        (c += e.height);
  ...
  Blockly.blockRendering.Debug.prototype.drawRender = function (a) {
    Blockly.blockRendering.Debug.config.render &&
      (a.setAttribute("filter", "url(#" + this.constants_.debugFilterId + ")"),
      setTimeout(function () {
  ...
  Blockly.Events.MarkerMove = function (a, b, c, d) {
    ...
    d &&
      d.getType() == Blockly.ASTNode.types.WORKSPACE &&
      (e = d.getLocation().id);
  ...
  Blockly.blockRendering.MarkerSvg.prototype.showAtLocation_ = function (a) {
    ...
    a.getType() == Blockly.ASTNode.types.BLOCK
      ...
      : b == Blockly.connectionTypes.INPUT_VALUE
  ...
  Blockly.blockRendering.MarkerSvg.prototype.fireMarkerEvent_ = function (
    ...
    a = new (Blockly.Events.get(Blockly.Events.MARKER_MOVE))(
      c,
      this.isCursor(),
      a,
      b
  ...
  Blockly.blockRendering.Renderer.prototype.orphanCanConnectAtEnd = function (
    ...
    c == Blockly.connectionTypes.OUTPUT_VALUE
  ...
  Blockly.blockRendering.Renderer.prototype.getConnectionPreviewMethod =
    function (a, b, c) {
      return b.type == Blockly.connectionTypes.OUTPUT_VALUE ||
        b.type == Blockly.connectionTypes.PREVIOUS_STATEMENT
        ? !a.isConnected() ||
  ...
  Blockly.zelos.RenderInfo.prototype.addInput_ = function (a, b) {
    a.type == Blockly.inputTypes.DUMMY &&
      b.hasDummyInput &&
      b.align == Blockly.constants.ALIGN.LEFT &&
      a.align == Blockly.constants.ALIGN.RIGHT &&
  ...
  Blockly.zelos.RenderInfo.prototype.finalizeOutputConnection_ = function () {
    if (this.outputConnection && this.outputConnection.isDynamicShape) {
      ...
      this.outputConnection.connectionOffsetX =
        this.outputConnection.shape.connectionOffsetX(b);
      c = 0;
      this.hasStatementInput ||
        this.bottomRow.hasNextConnection ||
        ((c = b),
