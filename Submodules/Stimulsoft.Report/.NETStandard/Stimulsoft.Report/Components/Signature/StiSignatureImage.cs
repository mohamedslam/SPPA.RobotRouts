...
namespace Stimulsoft.Report.Components
{
    ...
    public class StiSignatureImage :
        IStiSignatureImage
    {
        #region enum Order
        public enum Order
        ...
        internal static StiSignatureImage CreateFromJsonObject(JObject jObject)
        {
            var title = new StiSignatureImage();
        ...
        [Editor("Stimulsoft.Report.Components.Design.StiElectronicSignatureImageEditor, Stimulsoft.Report.Design, " + StiVersion.VersionInfo, typeof(UITypeEditor))]
        ...
        public StiSignatureImage()
        {
        }

        [StiUniversalConstructor("Image")]
        public StiSignatureImage(byte[] image, bool aspectRatio, StiHorAlignment horAlignment, 
