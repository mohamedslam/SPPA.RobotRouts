...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [StiServiceBitmap(typeof(StiCrossFooterBand), "Stimulsoft.Report.Images.Components.StiCrossFooterBand.png")]
    ...
    public class StiCrossFooterBand : StiFooterBand
    {
        ...
        public override StiComponentId ComponentId => StiComponentId.StiCrossFooterBand;
        ...
        /// </summary>
        public override int ToolboxPosition => (int)StiComponentToolboxPosition.CrossFooterBand;
        public override StiToolboxCategory ToolboxCategory => StiToolboxCategory.Cross;

        /// <summary>
        /// Gets a component priority.
        /// </summary>
        public override int Priority => (int)StiComponentPriority.CrossFooterBand;
        ...
        /// </summary>
        public override string LocalizedName => StiLocalization.Get("Components", "StiCrossFooterBand");
        ...
        /// </summary>
        public StiCrossFooterBand() : this(RectangleD.Empty)
        {
        }
        ...
        public StiCrossFooterBand(RectangleD rect) : base(rect)
        {
