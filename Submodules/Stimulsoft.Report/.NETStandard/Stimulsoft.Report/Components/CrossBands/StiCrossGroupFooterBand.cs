...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [StiServiceBitmap(typeof(StiCrossGroupFooterBand), "Stimulsoft.Report.Images.Components.StiCrossGroupFooterBand.png")]
    ...
    public class StiCrossGroupFooterBand : StiGroupFooterBand
    {
        ...
        public override StiComponentId ComponentId => StiComponentId.StiCrossGroupFooterBand;
        ...
        /// </summary>
        public override int ToolboxPosition => (int)StiComponentToolboxPosition.CrossGroupFooterBand;
        ...
        /// </summary>
        public override string LocalizedName => StiLocalization.Get("Components", "StiCrossGroupFooterBand");
        ...
        /// </summary>
        public override int Priority => (int)StiComponentPriority.CrossGroupFooterBand;
        #endregion
        ...
        {
            return new StiCrossGroupFooterBand();
        }
        #endregion
        ...
        /// </summary>
        public StiCrossGroupFooterBand() : this(RectangleD.Empty)
        {
        }
        ...
        /// </summary>
        /// <param name="rect">The rectangle describes sizes and positions of the component.</param>
        public StiCrossGroupFooterBand(RectangleD rect) : base(rect)
        {
