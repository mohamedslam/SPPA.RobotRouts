...
namespace Stimulsoft.Report.Components.TextFormats.Design
{
	...
	/// </summary>
	public class StiCurrencyFormatConverter : TypeConverter
	{
			...
			object value, Type destinationType)
		{
			...
			{
				var service = (StiCurrencyFormatService)value;
				...
				var info = typeof(StiCurrencyFormatService).GetConstructor(types);
				if (info != null)
				{
					var objs = !needState 
					    ? new object[]	
