...
namespace Stimulsoft.Report.Components.TextFormats.Design
{
	...
	/// </summary>
	public class StiBooleanFormatConverter : TypeConverter
	{
			...
			object value, Type destinationType)
		{
			...
			{
				var service = (StiBooleanFormatService)value;
				...
				var info = typeof(StiBooleanFormatService).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
