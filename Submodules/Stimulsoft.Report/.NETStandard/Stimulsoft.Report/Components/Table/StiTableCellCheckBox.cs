...
{
    [StiToolbox(false)]
    [StiGdiPainter(typeof(StiTableCellCheckBoxGdiPainter))]
    [StiWpfPainter("Stimulsoft.Report.Painters.StiTableCellCheckBoxWpfPainter, Stimulsoft.Report.Wpf, " + StiVersion.VersionInfo)]
    [StiQuickButton("Stimulsoft.Report.QuickButtons.Design.StiTableCellCheckBoxQuickButton, Stimulsoft.Report.Design, " + StiVersion.VersionInfo)]
    [StiWpfQuickButton("Stimulsoft.Report.WpfDesign.StiWpfTableCellCheckBoxQuickButton, Stimulsoft.Report.WpfDesign, " + StiVersion.VersionInfo)]
        ...
        IStiTableComponent
    {
        ...
        public override JObject SaveToJsonObject(StiJsonSaveMode mode)
        {
            ...
            jObject.AddPropertyEnum(nameof(CellType), CellType, StiTablceCellType.CheckBox);
        ...
        public override StiComponentId ComponentId => StiComponentId.StiTableCellCheckBox;
        ...
        {
            var cloneCell = (StiTableCellCheckBox)base.Clone(cloneProperties);
        ...
        /// </summary>
        [StiSerializable]
        [DefaultValue(StiTablceCellType.CheckBox)]
        [TypeConverter(typeof(StiEnumConverter))]
        [Editor(StiEditors.Enum, typeof(UITypeEditor))]
        [StiCategory("Cell")]
        ...
        private void CreateJoin()
        {
            ...
            if (JoinCells == null || JoinCells.Length == 0)
                return;
        ...
        public double GetRealWidth()
        {
            ...
            return (thisIndex - index) == 1 ? this.Right - cell.Right : cell.Width;
        }
        ...
        {
            return new StiTableCellCheckBox();
        }
        #endregion
    }
}