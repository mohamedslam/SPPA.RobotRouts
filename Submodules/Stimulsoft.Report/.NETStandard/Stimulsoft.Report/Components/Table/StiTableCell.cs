...
namespace Stimulsoft.Report.Components.Table
{
    ...
    [StiGdiPainter(typeof(StiTableCellTextGdiPainter))]
    [StiWpfPainter("Stimulsoft.Report.Painters.StiTableCellTextWpfPainter, Stimulsoft.Report.Wpf, " + StiVersion.VersionInfo)]
    [StiQuickButton("Stimulsoft.Report.QuickButtons.Design.StiTableCellTextQuickButton, Stimulsoft.Report.Design, " + StiVersion.VersionInfo)]
    [StiWpfQuickButton("Stimulsoft.Report.WpfDesign.StiWpfTableCellTextQuickButton, Stimulsoft.Report.WpfDesign, " + StiVersion.VersionInfo)]
    public class StiTableCell :
        StiText,
        IStiTableCell,
        IStiTableComponent
    {
        ...
        public override JObject SaveToJsonObject(StiJsonSaveMode mode)
        {
            ...
            jObject.AddPropertyEnum(nameof(CellType), CellType, StiTablceCellType.Text);
        ...
        public override void LoadFromJsonObject(JObject jObject)
        {
            ...
            if (JoinCells.Length == 0) join = false;
        }
        #endregion

        #region IStiPropertyGridObject
        public override StiComponentId ComponentId => StiComponentId.StiTableCell;
        ...
        {
            var cloneCell = (StiTableCell)base.Clone(cloneProperties);
        ...
        private StiTablceCellType cellType = StiTablceCellType.Text;
        /// <summary>
        /// Get or sets a type of the cell content.
        /// </summary>
        [StiSerializable]
        [Browsable(true)]
        [DefaultValue(StiTablceCellType.Text)]
        ...
        public double GetRealHeight()
        {
            ...
            return thisIndex - index == 1 ? cell.Height : Bottom - cell.Top - ((IStiTableCell)cell).GetRealHeight();
        }
        ...
        private void CreateJoin()
        {
            ...
            if (JoinCells.Length == 0) return;

            double valueLeft = 0;
            double valueTop = 0;
            for (var index = 0; index < JoinCells.Length - 1; index++)
            {
        ...
        private RectangleD GetNewClientRectangle()
        {
            ...
            var table = this.Parent as StiTable;
            bool isSingleColumnTable = (table != null) && (table.ColumnCount == 1);

            return ((thisIndex - index == 1) && !isSingleColumnTable)
