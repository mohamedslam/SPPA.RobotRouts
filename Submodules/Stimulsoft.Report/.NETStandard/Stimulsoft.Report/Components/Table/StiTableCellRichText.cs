...
namespace Stimulsoft.Report.Components.Table
{
    ...
    [StiGdiPainter(typeof(StiTableCellRichTextGdiPainter))]
    [StiWpfPainter("Stimulsoft.Report.Painters.StiTableCellRichTextWpfPainter, Stimulsoft.Report.Wpf, " + StiVersion.VersionInfo)]
    [StiQuickButton("Stimulsoft.Report.QuickButtons.Design.StiTableCellRichTextQuickButton, Stimulsoft.Report.Design, " + StiVersion.VersionInfo)]
    [StiWpfQuickButton("Stimulsoft.Report.WpfDesign.StiWpfTableCellRichTextQuickButton, Stimulsoft.Report.WpfDesign, " + StiVersion.VersionInfo)]
        ...
        IStiTableComponent
    {
        ...
        public override JObject SaveToJsonObject(StiJsonSaveMode mode)
        {
            ...
            jObject.AddPropertyEnum(nameof(CellType), CellType, StiTablceCellType.RichText);
        ...
        public override StiComponentId ComponentId => StiComponentId.StiTableCellRichText;
        ...
        {
            var cloneCell = (StiTableCellRichText) base.Clone(cloneProperties);
        ...
        private StiTablceCellType cellType = StiTablceCellType.RichText;
        /// <summary>
        /// Get or sets a type of the cell content.
        /// </summary>
        [StiSerializable]
        [DefaultValue(StiTablceCellType.RichText)]
        [TypeConverter(typeof(StiEnumConverter))]
        [Editor(StiEditors.Enum, typeof(UITypeEditor))]
        [StiCategory("Cell")]
        ...
        private RectangleD GetNewClientRectangle()
        {
            ...
            if (thisIndex - index == 1)
                return new RectangleD(cell.Right, cell.Top, this.Right - cell.Right, cell.Height);
            else
                return new RectangleD(cell.Left, cell.Bottom, cell.Width, this.Bottom - cell.Bottom);
        }
        ...
        {
            return new StiTableCellRichText();
        }
        #endregion
