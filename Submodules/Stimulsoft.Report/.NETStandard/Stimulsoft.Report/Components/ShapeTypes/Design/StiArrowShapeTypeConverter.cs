...
namespace Stimulsoft.Report.Components.ShapeTypes.Design
{
    ...
    /// </summary>
    public class StiComplexArrowShapeTypeConverter : StiShapeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var shape = (StiComplexArrowShapeType)value;
				...
				var info = typeof(StiComplexArrowShapeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
