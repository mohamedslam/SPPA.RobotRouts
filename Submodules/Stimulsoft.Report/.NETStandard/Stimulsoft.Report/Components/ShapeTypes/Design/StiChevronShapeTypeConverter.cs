...
namespace Stimulsoft.Report.Components.ShapeTypes.Design
{
    ...
    /// </summary>
    public class StiChevronShapeTypeConverter : StiShapeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var shape = (StiChevronShapeType)value;
				var types = new []
				{	
					typeof(StiShapeDirection)
				};

				var info = typeof(StiChevronShapeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
