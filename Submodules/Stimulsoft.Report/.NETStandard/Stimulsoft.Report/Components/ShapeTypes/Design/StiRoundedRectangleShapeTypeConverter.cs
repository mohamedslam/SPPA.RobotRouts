...
namespace Stimulsoft.Report.Components.ShapeTypes.Design
{
	...
	/// </summary>
	public class StiRoundedRectangleShapeTypeConverter : StiShapeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var shape = (StiRoundedRectangleShapeType)value;
				var types = new[]
				{
				    typeof(float)
				};

				var info = typeof(StiRoundedRectangleShapeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]
					{
