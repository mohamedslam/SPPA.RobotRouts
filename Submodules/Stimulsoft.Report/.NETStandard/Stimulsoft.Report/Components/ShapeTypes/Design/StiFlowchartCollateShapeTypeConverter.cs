...
namespace Stimulsoft.Report.Components.ShapeTypes.Design
{
    ...
    /// </summary>
    public class StiFlowchartCollateShapeTypeConverter : StiShapeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var shape = (StiFlowchartCollateShapeType)value;
				...
				var info = typeof(StiFlowchartCollateShapeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
