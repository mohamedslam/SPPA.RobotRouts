...
namespace Stimulsoft.Report.Components.ShapeTypes.Design
{
	...
	/// </summary>
	public class StiFlowchartPreparationShapeTypeConverter : StiShapeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var shape = (StiFlowchartPreparationShapeType)value;
				...
				var info = typeof(StiFlowchartPreparationShapeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
