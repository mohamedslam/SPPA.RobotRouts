...
namespace Stimulsoft.Report.Components.ShapeTypes.Design
{
    ...
    /// </summary>
    public class StiBentArrowShapeTypeConverter : StiShapeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var shape = (StiBentArrowShapeType)value;
				var types = new[]
				{	
					typeof(StiShapeDirection)
				};

				var info = typeof(StiBentArrowShapeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
