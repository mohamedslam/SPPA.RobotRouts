...
namespace Stimulsoft.Report.Components.ShapeTypes
{
    ...
    public class StiBentArrowShapeType : StiShapeTypeService
    {
        ...
        [Browsable(false)]
        public override StiComponentId ComponentId => StiComponentId.StiBentArrowShapeType;
		...
		/// Gets a service name.
		/// </summary>
		public override string ServiceName => StiLocalization.Get("Shapes", "BentArrow");
        #endregion
        ...
        public override StiShapeTypeService CreateNew() => new StiBentArrowShapeType();
        #endregion
