...
namespace Stimulsoft.Report.Dashboard
{
    ...
    /// </summary>
    public class StiDataFiltersDesigner : StiComponentDesigner
    {
        #region Methods
        /// <summary>
        ...
        public static StiComponentDesigner GetDataFiltersDesigner(IStiDesignerBase designer, Type componentType)
        {
            var attrs = componentType.GetCustomAttributes(typeof(StiDataFiltersDesignerAttribute), true) as StiDataFiltersDesignerAttribute[];
        ...
        public StiDataFiltersDesigner(IStiDesignerBase designer) : base(designer)
        {
        }
    }
}
