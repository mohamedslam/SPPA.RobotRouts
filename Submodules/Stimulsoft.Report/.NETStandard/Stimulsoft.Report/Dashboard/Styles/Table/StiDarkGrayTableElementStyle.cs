...
{
    public class StiDarkGrayTableElementStyle : StiTableElementStyle
    {
        #region IStiPropertyGridObject
        public override StiComponentId ComponentId => StiComponentId.StiDarkGrayDashboardTableStyle;
        #endregion
        ...
        public override Color HeaderBackColor { get; set; } = StiColor.Get("6b6e75");

        public override Color HeaderForeColor { get; set; } = StiColor.Get("ddd");

        public override Color FooterBackColor { get; set; } = StiColor.Get("6b6e75");
