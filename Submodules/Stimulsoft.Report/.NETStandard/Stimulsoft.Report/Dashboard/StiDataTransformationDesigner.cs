...
namespace Stimulsoft.Report.Dashboard
{
    ...
    public class StiDataTransformationDesigner : StiComponentDesigner
    {
        ...
        public static StiComponentDesigner GetTransformationDesigner(IStiDesignerBase designer, Type componentType)
        {
            var attrs = componentType.GetCustomAttributes(typeof(StiDataTransformationDesignerAttribute), true) as StiDataTransformationDesignerAttribute[];
        ...
        public StiDataTransformationDesigner(IStiDesignerBase designer) : base(designer)
        {
        }
    }
}
