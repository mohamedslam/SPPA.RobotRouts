...
namespace Stimulsoft.Report.Dictionary
{
	...
	public class StiDB2Database : StiSqlDatabase
	{
        #region Properties
        public override StiComponentId ComponentId => StiComponentId.StiDB2Database;
        #endregion

        #region Methods
        public override StiDatabase CreateNew()
        {
            return new StiDB2Database();
        }
        ...
        {
            return new StiDB2Source(nameInSource, name);
        }
		...
		/// <summary>
        /// Creates a new object of the type StiDB2Database.
		/// </summary>
        public StiDB2Database()
        ...
        /// Creates a new object of the type StiDB2Database.
		/// </summary>
        public StiDB2Database(string name, string connectionString)
        ...
        /// Creates a new object of the type StiDB2Database.
		/// </summary>
        public StiDB2Database(string name, string alias, string connectionString) 
		...
		/// Creates a new object of the type StiDB2Database.
		/// </summary>
		public StiDB2Database(string name, string alias, string connectionString, bool promptUserNameAndpassword) 
            : base(name, alias, connectionString, promptUserNameAndpassword)
		{
		}

        public StiDB2Database(string name, string alias, string connectionString, bool promptUserNameAndpassword, string key) 
