...
namespace Stimulsoft.Report.Dictionary
{
    ...
    public class StiMariaDbSource : StiMySqlSource
    {        
        #region Methods
        /// <summary>
        ...
        public override StiComponentId ComponentId => StiComponentId.StiMariaDbSource;

        public override StiDataSource CreateNew()
        {
            return new StiMariaDbSource();
        }
        #endregion

        public StiMariaDbSource()
            : this("", "", "")
        {
        }

        public StiMariaDbSource(string nameInSource, string name)
            : this(nameInSource, name, name)
        {
        }

        public StiMariaDbSource(string nameInSource, string name, string alias)
            : this(nameInSource, name, alias, string.Empty)
        {
        }

        public StiMariaDbSource(string nameInSource, string name, string alias, string sqlCommand)
            :
