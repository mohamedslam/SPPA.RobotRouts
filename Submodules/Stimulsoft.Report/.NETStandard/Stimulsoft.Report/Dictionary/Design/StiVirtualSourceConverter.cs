...
{
	/// <summary>
	/// Converts StiVirtualSource from one data type to another. 
	/// </summary>
	public class StiVirtualSourceConverter : TypeConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var data = (StiVirtualSource)value;
				...
				var info = typeof(StiVirtualSource).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
                    {	
