...
{
    public class StiGoogleAnalyticsDatabaseConverter : TypeConverter
    {
            ...
            object value, Type destinationType)
        {
            ...
            {
                var data = (StiGoogleAnalyticsDatabase)value;
                ...
                var info = typeof(StiGoogleAnalyticsDatabase).GetConstructor(types);
                if (info != null)
                {
                    var objs = new object[]
                    {
