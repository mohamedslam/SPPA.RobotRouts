...
namespace Stimulsoft.Report.Dictionary.Design
{
    ...
    /// </summary>
    public class StiCrossTabDataSourceConverter : TypeConverter
    {
            ...
            object value, Type destinationType)
        {
            ...
            {
                var data = (StiCrossTabDataSource)value;
                ...
                var info = typeof(StiCrossTabDataSource).GetConstructor(types);
                if (info != null)
                {
                    var objs = new object[]	
                    {	
