...
{
    /// <summary>
    /// Converts JsonDatabase from one data type to another. 
    /// </summary>
    public class StiGisDatabaseConverter : TypeConverter
	{
			...
			object value, Type destinationType) 
		{
			if (destinationType == typeof(InstanceDescriptor) && value != null)
			{
                ...
                {	 
                    ...
                    typeof(string),
                    typeof(string),
					typeof(StiGisDataType)
                };

				var info = typeof(StiGisDatabase).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
                    {	
