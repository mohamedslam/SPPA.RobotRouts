...
{
    public class StiFirebaseDatabaseConverter : StiSqlDatabaseConverter
    {
            ...
            object value, Type destinationType)
        {
            ...
            {
                var data = (StiFirebaseDatabase)value;
                ...
                var info = typeof(StiFirebaseDatabase).GetConstructor(types);
                if (info != null)
                {
                    var objs = new object[]
                    {
