...
{
    /// <summary>
    /// Converts GoogleSheetsDatabase from one data type to another. 
	/// </summary>
    public class StiGoogleSheetsDatabaseConverter : TypeConverter
    {
            ...
            object value, Type destinationType)
        {
            ...
            {
                var data = (StiGoogleSheetsDatabase)value;
                ...
                var info = typeof(StiGoogleSheetsDatabase).GetConstructor(types);
                if (info != null)
                {
                    var objs = new object[]
                    {
