...
{
	/// <summary>
	/// Converts CsvDatabase from one data type to another. 
	/// </summary>
    public class StiCsvDatabaseConverter : TypeConverter
	{
			...
			object value, Type destinationType) 
		{
			if (destinationType == typeof(InstanceDescriptor) && value != null)
			{
				...
				var info = typeof(StiCsvDatabase).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
                    {	
