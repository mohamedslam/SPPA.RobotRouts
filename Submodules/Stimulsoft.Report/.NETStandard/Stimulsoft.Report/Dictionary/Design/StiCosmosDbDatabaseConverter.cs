...
{
    public class StiCosmosDbDatabaseConverter : StiSqlDatabaseConverter
    {
            ...
            object value, Type destinationType)
        {
            ...
            {
                var data = (StiCosmosDbDatabase)value;
                ...
                var info = typeof(StiCosmosDbDatabase).GetConstructor(types);
                if (info != null)
                {
                    var objs = new object[]
                    {
