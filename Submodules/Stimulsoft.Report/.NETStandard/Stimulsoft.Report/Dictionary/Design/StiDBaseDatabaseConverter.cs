...
{
	/// <summary>
	/// Converts DBaseDatabase from one data type to another. 
	/// </summary>
    public class StiDBaseDatabaseConverter : TypeConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
                var data = (StiDBaseDatabase)value;
				...
				var info = typeof(StiDBaseDatabase).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
                    {	
