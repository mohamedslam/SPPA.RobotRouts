...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMinDateFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MinDate";
        #endregion
        ...
        public override void RestoreState(string stateName)
        {
            ...
            {
                minimum = (DateTime)States.Pop(stateName, this, "minimum");
        ...
        public StiMinDateFunctionService(bool runningTotal) : base(runningTotal)
        {
        }
