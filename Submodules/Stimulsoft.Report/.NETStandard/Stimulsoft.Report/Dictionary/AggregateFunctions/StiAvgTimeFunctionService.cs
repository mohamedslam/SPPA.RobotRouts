...
namespace Stimulsoft.Report.Dictionary
{
    ...
    public class StiAvgTimeFunctionService : StiAggregateFunctionService
    {
        ...
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "AvgTime";
        #endregion
        ...
        public override void RestoreState(string stateName)
        {
            ...
            {
                avgValue = (decimal)States.PopDecimal(stateName, this, "avgValue");
        ...
        public override object GetValue()
        {
            ...
            return new TimeSpan((long)(avgValue / count));
        }
        ...
        {
            throw new ArgumentException("You can't set calculation result to AvgTime function!");
        }
        ...
        public StiAvgTimeFunctionService(bool runningTotal) : base(runningTotal)
        {
        }
