...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMaxDateFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MaxDate";
        #endregion
        ...
        public override void RestoreState(string stateName)
        {
            ...
            {
                maximum = (DateTime)States.Pop(stateName, this, "maximum");
        ...
        public StiMaxDateFunctionService(bool runningTotal) : base(runningTotal)
        {
        }
