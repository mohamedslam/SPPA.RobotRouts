...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMaxIntFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MaxI";
        #endregion
        ...
        {
            States.PushInt64(stateName, this, "maximum", maximum);
        }
        ...
        public override void RestoreState(string stateName)
        {
            if (States.IsExist(stateName, this))
                maximum = States.PopInt64(stateName, this, "maximum");
        }
        #endregion
        ...
        public StiMaxIntFunctionService(bool runningTotal) : base(runningTotal)
        {
        }
