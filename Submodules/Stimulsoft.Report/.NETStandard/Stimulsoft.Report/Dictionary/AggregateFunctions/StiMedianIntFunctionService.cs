...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMedianIntFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MedianI";
        #endregion
        ...
        public override void CalcItem(object value)
        {
            ...
            var val = StiObjectConverter.ConvertToInt64(value);
            values.Add(val);
        }
        ...
        public override object GetValue()
        {
            ...
            if (values.Count == 1) return (long)values[0];

            values.Sort();

            var middlePosition = values.Count / 2;
            if (values.Count % 2 == 1)
                return (long) values[middlePosition];

            var value1 = (long) values[middlePosition - 1];
            var value2 = (long) values[middlePosition];
        ...
        public StiMedianIntFunctionService(bool runningTotal) : base(runningTotal)
        {
        }
