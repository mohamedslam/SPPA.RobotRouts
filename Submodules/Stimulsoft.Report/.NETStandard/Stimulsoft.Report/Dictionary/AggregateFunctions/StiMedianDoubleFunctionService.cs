...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMedianDoubleFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MedianD";
        #endregion
        ...
        public override object GetValue()
        {
            ...
            if (values.Count % 2 == 1)
                return (double) values[middlePosition];

            var value1 = (double) values[middlePosition - 1];
            var value2 = (double) values[middlePosition];
        ...
        {
            throw new ArgumentException("You can't set calculation result to MedianD function!");
        }
        ...
        public StiMedianDoubleFunctionService(bool runningTotal) : base(runningTotal)
        {
        }
