...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMinIntFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MinI";
        #endregion
        ...
        {
            States.PushInt64(stateName, this, "minimum", minimum);
        }
        ...
        public override void RestoreState(string stateName)
        {
            if (States.IsExist(stateName, this))
                minimum = States.PopInt64(stateName, this, "minimum");
        }
        #endregion
        ...
        public StiMinIntFunctionService(bool runningTotal) : base(runningTotal)
        {
        }

        public StiMinIntFunctionService()
        {
        }
    }
}
