...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMinDoubleFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MinD";
        #endregion
        ...
        {
            States.PushDouble(stateName, this, "minimum", minimum);
        }
        ...
        public override void RestoreState(string stateName)
        {
            if (States.IsExist(stateName, this))
                minimum = States.PopDouble(stateName, this, "minimum");
        }
        #endregion
        ...
        public StiMinDoubleFunctionService(bool runningTotal) : base(runningTotal)
        {
        }

        public StiMinDoubleFunctionService()
        {
        }
    }
}
