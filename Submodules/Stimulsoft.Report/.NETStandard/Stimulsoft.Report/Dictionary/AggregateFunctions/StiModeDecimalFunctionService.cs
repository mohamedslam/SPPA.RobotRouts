...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiModeDecimalFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "Mode";
        #endregion
        ...
        public StiModeDecimalFunctionService(bool runningTotal)
            : base(runningTotal)
        {
        }
