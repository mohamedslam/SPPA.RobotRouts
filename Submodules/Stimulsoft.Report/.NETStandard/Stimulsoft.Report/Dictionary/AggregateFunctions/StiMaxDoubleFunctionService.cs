...
namespace Stimulsoft.Report.Dictionary
{
    ...
    /// </summary>
    public class StiMaxDoubleFunctionService : StiAggregateFunctionService
    {
        #region StiService override
        /// <summary>
        /// Gets a service name.
        /// </summary>
        public override string ServiceName => "MaxD";
        #endregion
        ...
        {
            States.PushDouble(stateName, this, "maximum", maximum);
        }
        ...
        public override void RestoreState(string stateName)
        {
            if (States.IsExist(stateName, this))
                maximum = States.PopDouble(stateName, this, "maximum");
        }
        #endregion
        ...
        public StiMaxDoubleFunctionService(bool runningTotal) : base(runningTotal)
        {
        }

        public StiMaxDoubleFunctionService()
        {
        }
    }
}
