...
namespace Stimulsoft.Report.Units
{
	...
	/// </summary>
	public class StiCentimetersUnit : StiUnit
	{
        #region Properties
        public override string ToString()
		{
			return Loc.Get("PropertyEnum", "StiReportUnitTypeCentimeters");
		}
		
		/// <summary>
		/// Gets ruler step.
		/// </summary>
		public override double RollerStep => 1;
