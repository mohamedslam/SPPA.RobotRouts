...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiBookmarkExpressionConverter))]
	public class StiBookmarkExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
        ...
        /// </summary>
        public StiBookmarkExpression() : this(string.Empty)
		{
		}
		...
		public StiBookmarkExpression(string val) : base(val)
		{
		...
		/// Creates a new expression.
		/// </summary>
		public StiBookmarkExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}
