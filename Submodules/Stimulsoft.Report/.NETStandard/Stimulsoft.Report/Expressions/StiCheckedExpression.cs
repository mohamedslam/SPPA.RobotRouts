...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiCheckedExpressionConverter))]
	public class StiCheckedExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		/// </summary>
		public StiCheckedExpression() : this(string.Empty)
		{
		}
		...
		public StiCheckedExpression(string value) : base(value)
		{
		}
		...
		/// Creates a new expression.
		/// </summary>
		public StiCheckedExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}