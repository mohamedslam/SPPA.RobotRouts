...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiGroupConditionExpressionConverter))]
	public class StiGroupConditionExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		{
			return new StiGetGroupConditionEvent();
		}
        #endregion
		...
		/// </summary>
		public StiGroupConditionExpression() : this(string.Empty)
		{
		}
		...
		public StiGroupConditionExpression(string value) : base(value)
		{
		}
		...
		/// Creates a new expression.
		/// </summary>
		public StiGroupConditionExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}