...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiDataUrlExpressionConverter))]
	public class StiDataUrlExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		/// </summary>
		public StiDataUrlExpression() : this(string.Empty)
		{
		}
		...
		public StiDataUrlExpression(string value) : base(value)
		{
		...
		/// Creates a new expression.
		/// </summary>
		public StiDataUrlExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}