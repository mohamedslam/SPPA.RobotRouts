...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiExcelValueExpressionConverter))]
	public class StiExcelValueExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		{
			return new StiGetExcelValueEvent();
		}
        #endregion
		...
		/// </summary>
		public StiExcelValueExpression() : this(string.Empty)
		{
		}
		...
		public StiExcelValueExpression(string value) : base(value)
		{
		...
		/// Creates a new expression.
		/// </summary>
		public StiExcelValueExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}