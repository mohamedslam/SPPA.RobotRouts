...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiArgumentExpressionConverter))]
	public class StiArgumentExpression : StiExpression
	{
        #region Properties
        [Browsable(false)]
		...
		{
			return new StiGetArgumentEvent();
		}
        #endregion
        ...
        /// </summary>
        public StiArgumentExpression() : this(string.Empty)
		{
		}
		...
		public StiArgumentExpression(string value) : base(value)
		{			
		}
	}
}