...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiGroupSummaryExpressionConverter))]
	public class StiGroupSummaryExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		{
			return new StiGetSummaryExpressionEvent();
		}
        #endregion
		...
		/// </summary>
		public StiGroupSummaryExpression() : this(string.Empty)
		{
		}
		...
		public StiGroupSummaryExpression(string value) : base(value)
		{
		}
		...
		/// Creates a new expression.
		/// </summary>
        public StiGroupSummaryExpression(StiComponent parent, string propertyName)
