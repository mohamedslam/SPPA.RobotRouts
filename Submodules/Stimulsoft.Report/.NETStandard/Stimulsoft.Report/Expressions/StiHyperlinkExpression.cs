...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiHyperlinkExpressionConverter))]
	public class StiHyperlinkExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		{
			return new StiGetHyperlinkEvent();
		}
        #endregion
		...
		/// </summary>
		public StiHyperlinkExpression() : this(string.Empty)
		{
		}
		...
		public StiHyperlinkExpression(string value) : base(value)
		{
		...
		/// Creates a new expression.
		/// </summary>
		public StiHyperlinkExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}