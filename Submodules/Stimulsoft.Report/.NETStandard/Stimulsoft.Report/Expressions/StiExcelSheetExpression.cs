...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiExcelSheetExpressionConverter))]
	public class StiExcelSheetExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		/// </summary>
		public StiExcelSheetExpression() : this(string.Empty)
		{
		}
		...
		public StiExcelSheetExpression(string value) : base(value)
		{
		...
		/// Creates a new expression.
		/// </summary>
		public StiExcelSheetExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}