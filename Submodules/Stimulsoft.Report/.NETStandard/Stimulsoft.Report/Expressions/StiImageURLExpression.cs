...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiImageURLExpressionConverter))]
	public class StiImageURLExpression : StiUnifiedExpression
	{
	    #region Properties
        [Browsable(false)]
		...
		{
			return new StiGetImageURLEvent();
		}
        #endregion
		...
		/// </summary>
		public StiImageURLExpression() : this(string.Empty)
		{
		}
		...
		public StiImageURLExpression(string value) : base(value)
		{
		}
		...
		/// Creates a new expression.
		/// </summary>
		public StiImageURLExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}