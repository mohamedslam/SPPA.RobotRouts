...
{
    public class StiChordGdiShapeTypePainter : StiGdiShapeTypePainter
    {
        ...
        public override void Paint(object context, StiShape shape, StiShapeTypeService shapeType, RectangleF rect, float zoom)
        {
            ...
            {
                var clientRect = new Rectangle((int) rect.X, (int) rect.Y, (int) rect.Width, (int) rect.Height);
                path.AddPie(clientRect, 45f, 225f);
