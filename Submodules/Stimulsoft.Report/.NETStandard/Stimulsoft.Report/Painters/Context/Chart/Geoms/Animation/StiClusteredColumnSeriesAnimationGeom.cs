...
namespace Stimulsoft.Base.Context
{
    public class StiClusteredColumnSeriesAnimationGeom : StiAnimationGeom
    {
        ...
        public override StiGeomType Type => StiGeomType.AnimationColumn;
        #endregion

        public StiClusteredColumnSeriesAnimationGeom(StiBrush wpfBackColor, object background, StiPenGeom borderPen, object columnRect,
        ...
        public StiClusteredColumnSeriesAnimationGeom(StiBrush wpfBackColor, object background, StiPenGeom borderPen, object columnRect, StiCornerRadius cornerRadius,
            double? value, string toolTip, object tag, StiAnimation animation, StiInteractionDataGeom interaction) : base(animation, interaction)
        {
        ...
        public StiClusteredColumnSeriesAnimationGeom(object background, StiPenGeom borderPen, object columnRect,
            double? value, string toolTip, object tag, StiAnimation animation, StiInteractionDataGeom interaction) : base(animation, interaction)
        {
            this.Value = value;
            this.Background = background;
