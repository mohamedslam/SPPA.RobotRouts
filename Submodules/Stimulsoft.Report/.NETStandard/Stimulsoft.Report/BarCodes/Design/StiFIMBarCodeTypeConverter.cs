...
namespace Stimulsoft.Report.BarCodes.Design
{
    ...
    /// </summary>
    public class StiFIMBarCodeTypeConverter : StiBarCodeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var barCode = (StiFIMBarCodeType)value;				
				...
				var info = typeof(StiFIMBarCodeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
