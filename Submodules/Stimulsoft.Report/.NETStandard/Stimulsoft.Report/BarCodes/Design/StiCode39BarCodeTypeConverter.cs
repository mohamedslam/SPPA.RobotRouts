...
namespace Stimulsoft.Report.BarCodes.Design
{
	...
	/// </summary>
	public class StiCode39BarCodeTypeConverter : StiBarCodeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var barCode = (StiCode39BarCodeType)value;				
				var types = new[]
				{	
					typeof(float),
					typeof(float),
				...
				var info = typeof(StiCode39BarCodeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{
