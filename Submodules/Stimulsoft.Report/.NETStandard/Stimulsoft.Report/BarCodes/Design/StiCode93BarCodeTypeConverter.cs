...
namespace Stimulsoft.Report.BarCodes.Design
{
    ...
    /// </summary>
    public class StiCode93BarCodeTypeConverter : StiBarCodeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var barCode = (StiCode93BarCodeType)value;				
				...
				var info = typeof(StiCode93BarCodeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{	
