...
namespace Stimulsoft.Report.BarCodes.Design
{
    ...
    /// </summary>
    public class StiAztecBarCodeTypeConverter : StiBarCodeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var barCode = (StiAztecBarCodeType)value;				
                ...
                var info = typeof(StiAztecBarCodeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{
