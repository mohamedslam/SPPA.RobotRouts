...
namespace Stimulsoft.Report.BarCodes.Design
{
    ...
    /// </summary>
    public class StiCodabarBarCodeTypeConverter : StiBarCodeTypeServiceConverter
	{
			...
			object value, Type destinationType) 
		{
			...
			{
				var barCode = (StiCodabarBarCodeType)value;
			    var types = new []
				{	
					typeof(float),
					typeof(float),
				...
				var info = typeof(StiCodabarBarCodeType).GetConstructor(types);
				if (info != null)
				{
					var objs = new object[]	
					{														
