...
namespace Stimulsoft.Report.BarCodes
{
	...
	/// </summary>
	public class StiCode128cBarCodeType : StiCode128BarCodeType
	{
        #region IStiPropertyGridObject
        [Browsable(false)]
        public override StiComponentId ComponentId => StiComponentId.StiCode128cBarCodeType;
		...
		/// Gets a service name.
		/// </summary>
		public override string ServiceName => "Code128c";
        #endregion
		...
		{		
            ...
            //make barsArray
			var fullCode = new int[sbCode.Length + 3];
			fullCode[0] = 105;
			for (int index = 0; index < sbCode.Length; index++) 
			{
				fullCode[index + 1] = (int)sbCode[index];
			}
        ...
        public override StiBarCodeTypeService CreateNew() => new StiCode128cBarCodeType();
        #endregion

		public StiCode128cBarCodeType() : this(13f, 1f)
		{
		}

		public StiCode128cBarCodeType(float module, float height) :
			base(module, height)
		{
		}
	}
