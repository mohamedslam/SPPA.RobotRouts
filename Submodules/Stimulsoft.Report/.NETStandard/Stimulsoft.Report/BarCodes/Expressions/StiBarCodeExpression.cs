...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(StiBarCodeExpressionConverter))]
	public class StiBarCodeExpression : StiUnifiedExpression
	{
        [Browsable(false)]
        ...
        public override StiEvent GetDefaultEvent() => new StiGetBarCodeEvent();
        
	    /// <summary>
		/// Creates a new expression.
		/// </summary>
		public StiBarCodeExpression() : this(string.Empty)
		{
		}
		...
		public StiBarCodeExpression(string value) : base(value)
		{			
		}
		...
		/// Creates a new expression.
		/// </summary>
		public StiBarCodeExpression(StiComponent parent, string propertyName) : base(parent, propertyName)
		{
		}
	}
}