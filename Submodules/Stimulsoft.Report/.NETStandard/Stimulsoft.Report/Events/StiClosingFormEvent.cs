...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiClosingFormEventConverter))]
	public class StiClosingFormEvent : StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new[]
			{
				...
				new StiParameterInfo(typeof(CancelEventArgs), "e")
			};
		}
		...
		{
			return typeof(CancelEventHandler);
		}
		...
		/// </summary>
		public StiClosingFormEvent() : this("")
		{
		}
		...
		public StiClosingFormEvent(string script) : base(script)
		{
		}
		...
		public StiClosingFormEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
