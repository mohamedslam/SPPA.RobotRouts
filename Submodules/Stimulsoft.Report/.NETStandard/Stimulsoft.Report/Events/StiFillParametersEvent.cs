...
{
	/// <summary>
    /// Describes the class for realization of the event FillParameters.
	/// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiFillParametersEventConverter))]
	public class StiFillParametersEvent: StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new[]
			{
				...
				new StiParameterInfo(typeof(StiFillParametersEventArgs), "e")
			};
		}
		...
		{
			return typeof(StiFillParametersEventHandler);
		}
		...
		/// </summary>
		public StiFillParametersEvent() : this("")
		{
		}
		...
		public StiFillParametersEvent(string script) : base(script)
		{
		}
        ...
        public StiFillParametersEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
