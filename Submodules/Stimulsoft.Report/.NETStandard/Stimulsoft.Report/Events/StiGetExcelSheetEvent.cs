...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetExcelSheetEventConverter))]
	public class StiGetExcelSheetEvent: StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new []
			{
			    ...
			    new StiParameterInfo(typeof(StiGetExcelSheetEventArgs), "e")
			};
		}
		...
		{
			return typeof(StiGetExcelSheetEventHandler);
		}
		...
		public StiGetExcelSheetEvent(string script):base(script)
		{
		}
		...
		public StiGetExcelSheetEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
