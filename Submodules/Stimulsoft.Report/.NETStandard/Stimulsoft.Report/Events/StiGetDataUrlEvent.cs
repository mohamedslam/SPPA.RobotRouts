...
{
	/// <summary>
	/// Describes the class for realization of the event GetDataUrl.
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetDataUrlEventConverter))]
	public class StiGetDataUrlEvent: StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new []
			{
				...
				new StiParameterInfo(typeof(StiGetDataUrlEventArgs), "e")
			};
		}
		...
		{
			return typeof(StiGetDataUrlEventHandler);
		}
		...
		/// </summary>
		public StiGetDataUrlEvent() : this("")
		{
		}
		...
		public StiGetDataUrlEvent(string script):base(script)
		{
		}
		...
		public StiGetDataUrlEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
