...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetFilterEventConverter))]
	public class StiGetFilterEvent: StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new []
			{
				...
				new StiParameterInfo(typeof(StiFilterEventArgs), "e")
			};
		}
		...
		{
			return typeof(StiFilterEventHandler);
		}
		...
		public StiGetFilterEvent(string script) : base(script)
		{
		}
		...
		public StiGetFilterEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
