...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetExcelValueEventConverter))]
	public class StiGetExcelValueEvent: StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new []
			{
				...
				new StiParameterInfo(typeof(StiGetExcelValueEventArgs), "e")
			};
		}
		...
		{
			return typeof(StiGetExcelValueEventHandler);
		}
		...
		/// </summary>
		public StiGetExcelValueEvent() : this("")
		{
		}
		...
		public StiGetExcelValueEvent(string script):base(script)
		{
		}
		...
		public StiGetExcelValueEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
