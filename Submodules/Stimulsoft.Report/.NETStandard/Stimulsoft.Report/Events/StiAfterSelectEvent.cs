...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiAfterSelectEventConverter))]
	public class StiAfterSelectEvent : StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new[]
			{
				...
				new StiParameterInfo(typeof(TreeViewEventArgs), "e")
			};
		}
		...
		/// </summary>
		public StiAfterSelectEvent() : this(string.Empty)
		{
		}
		...
		public StiAfterSelectEvent(string script) : base(script)
		{
		}
		...
		public StiAfterSelectEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
