...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetImageDataEventConverter))]
	public class StiGetImageDataEvent : StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new []
			{
			    ...
			    new StiParameterInfo(typeof(StiGetImageDataEventArgs), "e")
			};
		}
		...
		{
			return typeof(StiGetImageDataEventHandler);
		}
		...
		/// </summary>
		public StiGetImageDataEvent() : this("")
		{
		}
		...
		public StiGetImageDataEvent(string script) : base(script)
		{
		}
		...
		public StiGetImageDataEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
