...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetHyperlinkEventConverter))]
	public class StiGetHyperlinkEvent: StiEvent
	{
		/// <summary>
		...
		/// <summary>
		/// Creates a new object of the type StiGetHyperlinkEvent.
		/// </summary>
		public StiGetHyperlinkEvent() : this("")
		{
		}

		/// <summary>
		/// Creates a new object of the type StiGetHyperlinkEvent with specified arguments.
		/// </summary>
		/// <param name="script">Script of the event.</param>
		public StiGetHyperlinkEvent(string script):base(script)
		{
		}
		...
		public StiGetHyperlinkEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
