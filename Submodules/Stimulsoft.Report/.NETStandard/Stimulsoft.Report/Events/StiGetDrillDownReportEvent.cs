...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetDrillDownReportEventConverter))]
	public class StiGetDrillDownReportEvent : StiEvent
	{
		/// <summary>
		...
		public override StiParameterInfo[] GetParameters()
		{
			return new []
			{
				...
				new StiParameterInfo(typeof(StiGetDrillDownReportEventArgs), "e")
			};
		}
		...
		{
			return typeof(StiGetDrillDownReportEventHandler);
		}
		...
		{
			return "GetDrillDownReport";
		}

		/// <summary>
		/// Creates a new object of the type StiGetDrillDownReportEvent.
		/// </summary>
		public StiGetDrillDownReportEvent() : this("")
		{
		}
		...
		public StiGetDrillDownReportEvent(string script) : base(script)
		{
		}
		...
		public StiGetDrillDownReportEvent(StiComponent parent)
			: base(parent)
		{
		}
	}
