...
{
	/// <summary>
	/// Describes the class for realization of the event GetCrossValue.
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.CrossTab.Design.StiGetCrossValueEventConverter))]
	public class StiGetCrossValueEvent : StiEvent
	{
		/// <summary>
		...
		/// </summary>
		public StiGetCrossValueEvent() : this("")
		{
		}
		...
		public StiGetCrossValueEvent(string script) : base(script)
		{
		}
	}
}
