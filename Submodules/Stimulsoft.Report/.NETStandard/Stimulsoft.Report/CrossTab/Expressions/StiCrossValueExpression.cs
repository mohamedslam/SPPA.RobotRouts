...
namespace Stimulsoft.Report.CrossTab
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.CrossTab.Design.StiCrossValueExpressionConverter))]
	public class StiCrossValueExpression : StiExpression
	{
		/// <summary>
		...
		{
			return new StiGetCrossValueEvent();
		}
        ...
        /// </summary>
        public StiCrossValueExpression() : this(string.Empty)
		{
		}
		...
		public StiCrossValueExpression(string value) : base(value)
		{
