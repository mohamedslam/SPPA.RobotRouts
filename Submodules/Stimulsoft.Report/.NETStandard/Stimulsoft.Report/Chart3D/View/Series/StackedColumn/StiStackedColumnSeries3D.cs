...
{
    public class StiStackedColumnSeries3D :
        StiSeries3D,
        IStiStackedColumnSeries3D
    {
        ...
        public override JObject SaveToJsonObject(StiJsonSaveMode mode)
        {
            ...
            jObject.AddPropertyColor(nameof(Color), Color, Color.DarkGray);
        ...
        public override StiComponentId ComponentId
        {
            get
            {
                return StiComponentId.StiStackedColumnSeries3D;
            }
        }
        ...
        {
            return typeof(StiStackedColumnArea3D);
        }
        #endregion
        ...
        public StiStackedColumnSeries3D()
        {
            this.Core = new StiStackedColumnSeriesCoreXF3D(this);
        }
    }
}
