...
namespace Stimulsoft.Report.Chart
{
        ...
        IStiColor
    {
        ...
        public StiPlaneGeom3D(StiPoint3D sPoint1, StiPoint3D sPoint2, StiPoint3D ePoint1, StiPoint3D ePoint2, Color color, StiRender3D render) : 
            base(render)
        {
            this.Color = color;
