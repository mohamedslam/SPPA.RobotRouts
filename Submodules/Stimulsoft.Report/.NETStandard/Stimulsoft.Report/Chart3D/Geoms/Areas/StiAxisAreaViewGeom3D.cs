...
{
    public class StiAxisAreaViewGeom3D : StiAreaGeom
    {
        #region Properties
        ...
        private void DrawBorder(StiContext context)
        {
            ...
            //#region Draw Border
            //var pen = new StiPenGeom(Area.BorderColor);
            //context.DrawRectangle(pen, rect.X, rect.Y, rect.Width, rect.Height);
            //#endregion
        }
        #endregion

        public StiAxisAreaViewGeom3D(IStiArea area, RectangleF clientRectangle, StiRender3D render)
