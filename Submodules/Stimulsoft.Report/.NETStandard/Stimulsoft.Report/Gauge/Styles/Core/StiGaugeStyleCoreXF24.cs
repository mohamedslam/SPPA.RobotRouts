...
{
    public class StiGaugeStyleCoreXF24 : StiGaugeStyleCoreXF
    {
        #region Properties.Localization
        /// <summary>
        /// Gets a localized name of style.
        /// </summary>
        public override string LocalizedName => StiLocalization.Get("Chart", "Style") + "24";
        #endregion

        #region Properties
        public override StiBrush Brush => new StiSolidBrush("#ffffff");

        public override Color ForeColor { get; } = StiDashboardStyleHelper.GetForeColor(StiElementStyleIdent.Orange);

        public override Color BorderColor => Color.Transparent;

        public override float BorderWidth => 1;

        public override Color TargetColor => ColorTranslator.FromHtml("#ffc000");
        #endregion
        ...
        public override StiBrush LinearScaleBrush => new StiSolidBrush("#ed7d31");

        public override StiBrush LinearBarBrush => new StiSolidBrush("#ed7d31");
        ...
        public override StiBrush RadialBarBrush => new StiSolidBrush("#ed7d31");
        ...
        public override StiBrush NeedleBrush => new StiSolidBrush("#ed7d31");

        public override StiBrush NeedleBorderBrush => new StiEmptyBrush();

        public override StiBrush NeedleCapBrush => new StiSolidBrush("#ed7d31");

        public override StiBrush NeedleCapBorderBrush => new StiSolidBrush("#ed7d31");
