...
namespace Stimulsoft.Report.Gauge
{
    public class StiGaugeStyleCoreXF27 : StiGaugeStyleCoreXF
    {
        ...
        /// </summary>
        public override string LocalizedName => StiLocalization.Get("Chart", "Style") + "27";
        #endregion

        #region Properties
        public override StiBrush Brush => new StiSolidBrush("#33475B");

        public override Color ForeColor { get; } = StiDashboardStyleHelper.GetForeColor(StiElementStyleIdent.SlateGray);

        public override Color BorderColor => Color.Transparent;

        public override float BorderWidth => 1;

        public override Color TargetColor => ColorTranslator.FromHtml("#ec334d");
        ...
        public override StiBrush MarkerBrush => new StiSolidBrush("#ec334d");

        public override StiBrush LinearMarkerBorder => new StiSolidBrush("#ec334d");
        #endregion

        #region Properties.LinearScale
        public override StiBrush LinearScaleBrush => new StiSolidBrush("#0bac45");

        public override StiBrush LinearBarBrush => new StiSolidBrush("#0bac45");
        ...
        public override StiBrush RadialBarBrush => new StiSolidBrush("#0bac45");

        public override StiBrush RadialBarBorderBrush => new StiEmptyBrush();

        public override StiBrush RadialBarEmptyBrush => new StiSolidBrush("#3b4d5f");
        ...
        public override StiBrush NeedleBrush => new StiSolidBrush("#ec334d");
        ...
        public override StiBrush NeedleCapBorderBrush => new StiSolidBrush("#ec334d");
