...
{
    public class StiGaugeStyleCoreXF26 : StiGaugeStyleCoreXF
    {
        #region Properties.Localization
        /// <summary>
        /// Gets a localized name of style.
        /// </summary>
        public override string LocalizedName => StiLocalization.Get("Chart", "Style") + "26";
        #endregion
        ...
        public override Color ForeColor { get; } = StiDashboardStyleHelper.GetForeColor(StiElementStyleIdent.Turquoise);

        public override Color BorderColor => Color.Transparent;

        public override float BorderWidth => 1;

        public override Color TargetColor => ColorTranslator.FromHtml("#b5a1dd");
        ...
        #region Linear Scale
        public override StiBrush LinearScaleBrush => new StiSolidBrush("#2ec6c8");

        #region Bar
        public override StiBrush LinearBarBrush => new StiSolidBrush("#2ec6c8");
        ...
        #region Bar
        public override StiBrush RadialBarBrush => new StiSolidBrush("#2ec6c8");
        ...
        #region Needle
        public override StiBrush NeedleBrush => new StiSolidBrush("#2ec6c8");

        public override StiBrush NeedleBorderBrush => new StiEmptyBrush();

        public override StiBrush NeedleCapBrush => new StiSolidBrush("#2ec6c8");

        public override StiBrush NeedleCapBorderBrush => new StiSolidBrush("#2ec6c8");
