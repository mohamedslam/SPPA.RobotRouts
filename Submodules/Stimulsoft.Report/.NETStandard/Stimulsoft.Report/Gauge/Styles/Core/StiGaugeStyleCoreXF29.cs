...
{
    public class StiGaugeStyleCoreXF29 : StiGaugeStyleCoreXF
    {
        #region Properties.Localization
        /// <summary>
        /// Gets a localized name of style.
        /// </summary>
        public override string LocalizedName => StiLocalization.Get("Chart", "Style") + "29";
        #endregion

        #region Properties
        public override StiBrush Brush => new StiSolidBrush("#ffffff");

        public override Color ForeColor { get; } = StiDashboardStyleHelper.GetForeColor(StiElementStyleIdent.Blue);

        public override Color BorderColor => Color.Transparent;

        public override float BorderWidth => 1;

        public override Color TargetColor => ColorTranslator.FromHtml("#ef717a");
        #endregion
        ...
        #region Properties.Linear Scale
        public override StiBrush LinearScaleBrush => new StiSolidBrush("#3498db");

        public override StiBrush LinearBarBrush => new StiSolidBrush("#3498db");
        ...
        public override StiBrush RadialBarBrush => new StiSolidBrush("#3498db");

        public override StiBrush RadialBarBorderBrush => new StiEmptyBrush();

        public override StiBrush RadialBarEmptyBrush => new StiSolidBrush("#e7ebec");
        ...
        public override StiBrush NeedleBrush => new StiSolidBrush("#3498db");

        public override StiBrush NeedleBorderBrush => new StiEmptyBrush();

        public override StiBrush NeedleCapBrush => new StiSolidBrush("#3498db");

        public override StiBrush NeedleCapBorderBrush => new StiSolidBrush("#3498db");
