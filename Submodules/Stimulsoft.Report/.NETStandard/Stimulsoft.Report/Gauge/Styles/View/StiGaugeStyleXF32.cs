...
{
    public class StiGaugeStyleXF32 : StiGaugeStyleXF
    {
        ...
        public override StiGaugeStyleXF CreateNew() => new StiGaugeStyleXF32();
        #endregion

        public StiGaugeStyleXF32()
        {
            this.Core = new StiGaugeStyleCoreXF32();
        }
    }
}