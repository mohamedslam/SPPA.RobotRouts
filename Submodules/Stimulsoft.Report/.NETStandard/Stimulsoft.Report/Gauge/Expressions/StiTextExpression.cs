...
{
    [TypeConverter(typeof(StiTextExpressionConverter))]
    public class StiTextExpression : StiExpression
    {
        [Browsable(false)]
        ...
        public override StiEvent GetDefaultEvent() => new StiGetTextEvent();
        ...
        public StiTextExpression(string value)
            : base(value)
        {
