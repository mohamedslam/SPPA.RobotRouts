...
namespace Stimulsoft.Report.Components.Gauge
{
        ...
        StiScaleRangeList
    {
        ...
        [Browsable(false)]
        public override StiComponentId ComponentId => StiComponentId.StiRadialRangeList;
        #endregion
        ...
        #region Methods
        public override StiGaugeElement CreateNew() => new StiRadialRangeList();
        ...
        protected internal override void DrawElement(StiGaugeContextPainter context)
        {
            ...
            {
                var range = this.Ranges[index] as StiRadialRange;
                if (range != null)
                {
