...
namespace Stimulsoft.Report.Gauge.Events
{
    ...
    /// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Gauge.Events.Design.StiGetSkipValuesEventConverter))]
    public class StiGetSkipValuesEvent : StiEvent
	{
		/// <summary>
		...
		/// </summary>
		public override string ToString() => "GetSkipValues";

		/// <summary>
		/// Creates a new object of the type StiGetListOfArgumentsEvent.
		/// </summary>
		public StiGetSkipValuesEvent() : this("")
		{
		}
		...
		public StiGetSkipValuesEvent(string script):base(script)
		{
		}
        ...
        public StiGetSkipValuesEvent(StiComponent parent)
            : base(parent)
		{
		}
    }
