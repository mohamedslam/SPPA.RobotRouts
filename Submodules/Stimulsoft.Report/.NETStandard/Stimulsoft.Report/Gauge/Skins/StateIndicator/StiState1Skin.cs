...
{
    public class StiState1Skin : StiGaugeElementSkin
    {
        public override void Draw(StiGaugeContextPainter context, StiGaugeElement element, RectangleF rect, float? angle, PointF? centerPoint)
        {
            ...
            context.AddEllipseGaugeGeom(rect, indicator.Brush, indicator.BorderBrush, indicator.BorderWidth);
            ...
            if (indicator.ShowValue && value != null)
            {
                ...
                context.AddTextGaugeGeom(string.Format(indicator.Format, value.GetValueOrDefault()), zoomFont, indicator.TextBrush, rect, sf);
            }
        }
    }
}