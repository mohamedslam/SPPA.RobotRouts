...
{
    public class StiStackedSplineAreaSeriesCoreXF : StiStackedSplineSeriesCoreXF
    {
        ...
        {
            if (pointsInfo.PointsStart == null) return;
            if (pointsInfo.PointsEnd == null) return;

            StiStackedSplineAreaSeriesGeom seriesGeom = new StiStackedSplineAreaSeriesGeom(geom, pointsInfo, this.Series);
