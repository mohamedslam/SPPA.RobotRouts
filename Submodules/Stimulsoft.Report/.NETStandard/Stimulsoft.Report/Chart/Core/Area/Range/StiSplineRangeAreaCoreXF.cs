...
{
    public class StiSplineRangeAreaCoreXF : StiClusteredColumnAreaCoreXF
    {
        ...
        public override int Position
        {
            get
            {
                return (int)StiChartAreaPosition.SplineRange;
            }
        }
        #endregion
        ...
        protected override void PrepareRange(IStiAxis specXAxis, IStiAxis specXTopAxis, IStiAxis specYAxis, IStiAxis specYRightAxis)
        {
            ...
            {
                IStiSplineRangeSeries series = (IStiSplineRangeSeries)seriesCollection[index];
