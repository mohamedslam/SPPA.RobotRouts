...
{
    public class StiRightAxisLabelsCoreXF : StiCenterAxisLabelsCoreXF
    {
        ...
        public override int Position
        {
            get
            {
                return (int)StiSeriesLabelsPosition.Right;
            }
        }
        #endregion
        ...
        public StiRightAxisLabelsCoreXF(IStiSeriesLabels seriesLabels)
            : base(seriesLabels)
        {            
        }
	}
