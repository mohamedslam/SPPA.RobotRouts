...
{
    public class StiOutsideLeftPictorialStackedLabelsCoreXF : StiPictorialStackedLabelsCoreXF
    {
        ...
        public override void ApplyStyle(IStiChartStyle style)
        {
            ...
            {
                ((StiOutsideLeftPictorialStackedLabels)this.SeriesLabels).LineColor = style.Core.SeriesLabelsLineColor;
            }
        }
        #endregion 
            ...
            int colorIndex, int colorCount, float lineLength, RectangleF rect)
        {
            ...
            var point = new PointF(rect.Right, rect.Y + rect.Height / 2);

            var lineColor = ((StiOutsideLeftPictorialStackedLabels)this.SeriesLabels).LineColor;

            var labelRect = context.MeasureRotatedString(labelText, font, point, sf, StiRotationMode.RightCenter, 0f, (int)(this.SeriesLabels.Width * context.Options.Zoom));
            var lineRect = new RectangleF(rect.Right, rect.Y, lineLength, rect.Height);
        ...
        public override int Position
        {
            get
            {
                return (int)StiSeriesLabelsPosition.OutsideLeftPictorialStacked;
            }
        }
        #endregion
        ...
        public StiOutsideLeftPictorialStackedLabelsCoreXF(IStiSeriesLabels seriesLabels) : base(seriesLabels)
        {
        }
    }
}
