...
{
    public class StiOutsideRightFunnelLabelsCoreXF : StiFunnelSeriesLabelsCoreXF
    {
        #region Methods
            ...
            int colorIndex, int colorCount, RectangleF rect, float singleValueHeight, float singleValueWidth, float centerAxis, out RectangleF measureRect)
        {
            ...
            PointF endPoint = new PointF(rect.Width * 0.95f - labelRect.Width, singleValueHeight * pointIndex + singleValueHeight / 2 + rect.Height * 0.05f);

            RectangleF labelRectPosition = context.MeasureRotatedString(labelText, font,
                    endPoint, sf, StiRotationMode.LeftCenter, 0f, (int)(this.SeriesLabels.Width * context.Options.Zoom));
        ...
        public override int Position
        {
            get
            {
                return (int)StiSeriesLabelsPosition.OutsideRightFunnel;
            }
        }
        #endregion
