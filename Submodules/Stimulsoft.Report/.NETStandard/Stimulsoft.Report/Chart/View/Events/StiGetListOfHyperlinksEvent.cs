...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetListOfHyperlinksEventConverter))]
	public class StiGetListOfHyperlinksEvent : StiEvent
	{
		/// <summary>
		...
		{
			return "GetListOfHyperlinks";
		}

		/// <summary>
		/// Creates a new object of the type StiGetListOfHyperlinksEvent.
		/// </summary>
		public StiGetListOfHyperlinksEvent() : this("")
		{
		}

		/// <summary>
		/// Creates a new object of the type StiGetListOfHyperlinksEvent with specified arguments.
		/// </summary>
		/// <param name="script">Script of the event.</param>
		public StiGetListOfHyperlinksEvent(string script):base(script)
		{
		}
        ...
        public StiGetListOfHyperlinksEvent(StiComponent parent)
            : base(parent)
		{
		}
	}
