...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetListOfToolTipsEventConverter))]
	public class StiGetListOfToolTipsEvent : StiEvent
	{
		/// <summary>
		...
		{
			return "GetListOfToolTips";
		}

		/// <summary>
		/// Creates a new object of the type StiGetListOfToolTipsEvent.
		/// </summary>
		public StiGetListOfToolTipsEvent() : this("")
		{
		}

		/// <summary>
		/// Creates a new object of the type StiGetListOfToolTipsEvent with specified arguments.
		/// </summary>
		/// <param name="script">Script of the event.</param>
		public StiGetListOfToolTipsEvent(string script):base(script)
		{
		}
        ...
        public StiGetListOfToolTipsEvent(StiComponent parent)
            : base(parent)
		{
		}
	}
