...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(StiGetValueHighEventConverter))]
	public class StiGetValueHighEvent: StiEvent
	{
		/// <summary>
		...
		public StiGetValueHighEvent(string script):base(script)
		{
		}
        ...
        public StiGetValueHighEvent(StiComponent parent)
            : base(parent)
		{
		}
	}
