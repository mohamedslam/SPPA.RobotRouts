...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetListOfWeightsEventConverter))]
	public class StiGetListOfWeightsEvent : StiEvent
	{
		/// <summary>
		...
		{
			return "GetListOfWeights";
		}

		/// <summary>
        /// Creates a new object of the type StiGetListOfWeightsEvent.
		/// </summary>
		public StiGetListOfWeightsEvent() : this("")
		{
		}
		...
		public StiGetListOfWeightsEvent(string script):base(script)
		{
		}
        ...
        public StiGetListOfWeightsEvent(StiComponent parent)
            : base(parent)
		{
		}
	}
