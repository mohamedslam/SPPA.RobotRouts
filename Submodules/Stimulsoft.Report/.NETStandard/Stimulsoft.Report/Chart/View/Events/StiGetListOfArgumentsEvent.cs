...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetListOfArgumentsEventConverter))]
	public class StiGetListOfArgumentsEvent : StiEvent
	{
		/// <summary>
		...
		{
			return "GetListOfArguments";
		}

		/// <summary>
		/// Creates a new object of the type StiGetListOfArgumentsEvent.
		/// </summary>
		public StiGetListOfArgumentsEvent() : this("")
		{
		}
		...
		public StiGetListOfArgumentsEvent(string script):base(script)
		{
		}
		...
		public StiGetListOfArgumentsEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
