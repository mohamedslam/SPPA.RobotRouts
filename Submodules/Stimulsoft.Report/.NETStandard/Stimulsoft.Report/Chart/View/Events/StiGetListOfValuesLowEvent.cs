...
namespace Stimulsoft.Report.Events
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Events.Design.StiGetListOfValuesLowEventConverter))]
    public class StiGetListOfValuesLowEvent : StiEvent
	{
		/// <summary>
		...
		{
			return "GetListOfValuesLow";
		}

		/// <summary>
		/// Creates a new object of the type StiGetListOfValuesEndEvent.
		/// </summary>
		public StiGetListOfValuesLowEvent() : this("")
		{
		}
		...
		public StiGetListOfValuesLowEvent(string script):base(script)
		{
		}
		...
		public StiGetListOfValuesLowEvent(StiComponent parent) : base(parent)
		{
		}
	}
}
