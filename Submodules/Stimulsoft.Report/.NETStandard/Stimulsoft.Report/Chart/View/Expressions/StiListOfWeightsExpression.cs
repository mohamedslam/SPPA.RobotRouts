...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfWeightsExpressionConverter))]
	public class StiListOfWeightsExpression : StiExpression
	{
		[Browsable(false)]
		...
		{
			return new StiGetListOfWeightsEvent();
		}
		...
		/// </summary>
		public StiListOfWeightsExpression() : this(string.Empty)
		{
		}
        ...
        public StiListOfWeightsExpression(string value)
            : base(value)
		{
		}
	}
