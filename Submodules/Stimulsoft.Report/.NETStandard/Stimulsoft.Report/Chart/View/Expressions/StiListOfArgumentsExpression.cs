...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfArgumentsExpressionConverter))]
    public class StiListOfArgumentsExpression : StiExpression
    {
        [Browsable(false)]
        ...
        {
            return new StiGetListOfArgumentsEvent();
        }
        ...
        /// </summary>
        public StiListOfArgumentsExpression() : this(string.Empty)
        {
        }
        ...
        public StiListOfArgumentsExpression(string value) : base(value)
        {
        }
    }
}