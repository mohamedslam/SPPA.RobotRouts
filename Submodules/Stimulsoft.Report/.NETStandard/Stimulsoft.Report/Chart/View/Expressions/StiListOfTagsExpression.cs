...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfTagsExpressionConverter))]
    public class StiListOfTagsExpression : StiExpression
    {
        [Browsable(false)]
        ...
        {
            return new StiGetListOfTagsEvent();
        }
        ...
        /// </summary>
        public StiListOfTagsExpression() : this(string.Empty)
        {
        }
        ...
        public StiListOfTagsExpression(string value)
            : base(value)
        {
        }
    }
