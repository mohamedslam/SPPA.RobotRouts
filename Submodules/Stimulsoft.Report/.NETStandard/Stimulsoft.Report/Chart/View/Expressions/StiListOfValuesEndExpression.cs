...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfValuesEndExpressionConverter))]
	public class StiListOfValuesEndExpression : StiExpression
	{
		[Browsable(false)]
		...
		{
			return new StiGetListOfValuesEndEvent();
		}
		...
		/// </summary>
		public StiListOfValuesEndExpression() : this(string.Empty)
		{
		}
		...
		public StiListOfValuesEndExpression(string value) : base(value)
		{
		}
	}
}