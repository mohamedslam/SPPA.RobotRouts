...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfValuesCloseExpressionConverter))]
    public class StiListOfValuesCloseExpression : StiExpression
	{
		[Browsable(false)]
		...
		{
			return new StiGetListOfValuesCloseEvent();
		}
		...
		/// </summary>
		public StiListOfValuesCloseExpression() : this(string.Empty)
		{
		}
		...
		public StiListOfValuesCloseExpression(string value) : base(value)
		{
		}
	}
}
