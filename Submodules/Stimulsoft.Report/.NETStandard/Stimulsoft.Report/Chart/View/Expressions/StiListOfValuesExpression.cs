...
namespace Stimulsoft.Report.Components
{
	...
	/// </summary>
	[TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfValuesExpressionConverter))]
	public class StiListOfValuesExpression : StiExpression
	{
		[Browsable(false)]
		...
		{
			return new StiGetListOfValuesEvent();
		}
		...
		/// </summary>
		public StiListOfValuesExpression() : this(string.Empty)
		{
		}
		...
		public StiListOfValuesExpression(string value) : base(value)
		{
		}
	}
}