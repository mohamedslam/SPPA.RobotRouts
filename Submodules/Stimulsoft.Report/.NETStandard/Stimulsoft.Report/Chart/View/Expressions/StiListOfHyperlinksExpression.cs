...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfHyperlinksExpressionConverter))]
    public class StiListOfHyperlinksExpression : StiExpression
    {
        [Browsable(false)]
        ...
        {
            return new StiGetListOfHyperlinksEvent();
        }
        ...
        /// </summary>
        public StiListOfHyperlinksExpression() : this(string.Empty)
        {
        }
        ...
        public StiListOfHyperlinksExpression(string value)
            : base(value)
        {
        }
    }
