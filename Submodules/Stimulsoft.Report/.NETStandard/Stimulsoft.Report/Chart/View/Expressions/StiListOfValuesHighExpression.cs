...
namespace Stimulsoft.Report.Components
{
    ...
    /// </summary>
    [TypeConverter(typeof(Stimulsoft.Report.Components.Design.StiListOfValuesHighExpressionConverter))]
    public class StiListOfValuesHighExpression : StiExpression
	{
		[Browsable(false)]
		...
		{
			return new StiGetListOfValuesHighEvent();
		}
		...
		/// </summary>
		public StiListOfValuesHighExpression() : this(string.Empty)
		{
		}
		...
		public StiListOfValuesHighExpression(string value) : base(value)
		{
		}
	}
}
