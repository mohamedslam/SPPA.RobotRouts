...
{
    public class StiOutsideLeftPictorialStackedLabels :
        StiCenterPictorialStackedLabels,
        IStiOutsideLeftPictorialStackedLabels
    {
        #region Properties
        /// <summary>
        ...
        {
            return new StiOutsideLeftPictorialStackedLabels();
        }
        #endregion

        public StiOutsideLeftPictorialStackedLabels()
        {
            this.Core = new StiOutsideLeftPictorialStackedLabelsCoreXF(this);
        }
    }
}
