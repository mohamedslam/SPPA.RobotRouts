...
namespace Stimulsoft.Report.Chart
{
        ...
        IStiSplineRangeSeries
    {
        ...
        public override StiComponentId ComponentId
        {
            get
            {
                return StiComponentId.StiSplineRangeSeries;
            }
        }
        ...
        {
            IStiSplineRangeSeries series = base.Clone() as IStiSplineRangeSeries;
        ...
        {
            return typeof(StiSplineRangeArea);
        }
        #endregion
        ...
        private double?[] valuesEnd = { 4, 5, 9 };
        [Browsable(false)]
        ...
        {
            this.Core = new StiSplineRangeSeriesCoreXF(this);
        }
    }
}