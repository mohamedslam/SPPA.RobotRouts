...
namespace Stimulsoft.Report.Chart
{
        ...
        IStiSteppedRangeSeries
    {
        ...
        public override JObject SaveToJsonObject(StiJsonSaveMode mode)
        {
            ...
            jObject.AddPropertyJObject("ValueEnd", valueObjEnd.SaveToJsonObject(mode));
        ...
        public override void LoadFromJsonObject(JObject jObject)
        {
            ...
            foreach (var property in jObject.Properties())
            {
                switch (property.Name)
                {
                    ...
                    case "ValueEnd":
                        this.valueObjEnd.LoadFromJsonObject((JObject)property.Value);
                        break;
        ...
        public override StiComponentId ComponentId
        {
            get
            {
                return StiComponentId.StiSteppedRangeSeries;
            }
        }
        ...
        {
            IStiSteppedRangeSeries series = base.Clone() as IStiSteppedRangeSeries;
        ...
        {
            return typeof(StiSteppedRangeArea);
        }
        #endregion
        ...
        private double?[] valuesEnd = { 4, 5, 7, 6, 6 };
        [Browsable(false)]
        public double?[] ValuesEnd
        {
            get
            {
                ...
                return new double?[] { 3 + seriesIndex * 3, 5 + seriesIndex * 4, 7 + seriesIndex * 3, 6 + seriesIndex * 3, 6 + seriesIndex * 3 };
            }
            set
            {
                valuesEnd = value;
        ...
        {
            this.Core = new StiSteppedRangeSeriesCoreXF(this);
        }
    }
}
