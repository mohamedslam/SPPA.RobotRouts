...
namespace Stimulsoft.Report.Chart
{
        ...
        IStiRangeBarSeries        
    {
        ...
        public override void LoadFromJsonObject(JObject jObject)
        {
            ...
            foreach (var property in jObject.Properties())
            {
                switch (property.Name)
                {
                    ...
                    case "Value":
                        this.Value.LoadFromJsonObject((JObject)property.Value);
                        break;
                    ...
                    case "ListOfValues":
                        this.ListOfValues.LoadFromJsonObject((JObject)property.Value);
                        break;
        ...
        public override StiComponentId ComponentId
        {
            get
            {
                return StiComponentId.StiRangeBarSeries;
            }
        }
        ...
        {
            IStiRangeBarSeries series = base.Clone() as IStiRangeBarSeries;
        ...
        {
            this.Core = new StiRangeBarSeriesCoreXF(this);
        }
    }
}