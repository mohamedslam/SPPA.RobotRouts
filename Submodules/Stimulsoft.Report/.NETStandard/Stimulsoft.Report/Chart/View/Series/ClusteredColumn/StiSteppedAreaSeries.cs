...
namespace Stimulsoft.Report.Chart
{
        ...
        IStiSteppedAreaSeries
	{
        ...
        public override StiComponentId ComponentId
        {
            get
            {
                return StiComponentId.StiSteppedAreaSeries;
            }
        }
		...
		{
			IStiSteppedAreaSeries series =	base.Clone() as IStiSteppedAreaSeries;
        ...
        {
            this.Core = new StiSteppedAreaSeriesCoreXF(this);
        }
	}
}