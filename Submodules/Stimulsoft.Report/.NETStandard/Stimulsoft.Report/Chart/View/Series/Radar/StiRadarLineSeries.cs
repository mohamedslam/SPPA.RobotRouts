...
{
    public class StiRadarLineSeries : 
        StiRadarSeries,
        IStiRadarLineSeries
    {
        ...
        public override StiComponentId ComponentId
        {
            get
            {
                return StiComponentId.StiRadarLineSeries;
            }
        }
        ...
        {
            return typeof(StiRadarLineArea);
        }
        #endregion
        ...
        public StiRadarLineSeries()
        {
            this.Core = new StiRadarLineSeriesCoreXF(this);
        }
	}
}