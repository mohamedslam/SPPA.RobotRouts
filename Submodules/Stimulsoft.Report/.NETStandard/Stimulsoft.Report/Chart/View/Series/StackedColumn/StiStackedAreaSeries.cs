...
{
    public class StiStackedAreaSeries : 
        ...
        IStiStackedAreaSeries
	{
        ...
        public override StiComponentId ComponentId
        {
            get
            {
                return StiComponentId.StiStackedAreaSeries;
            }
        }
		...
		{
			IStiStackedAreaSeries series =	base.Clone() as IStiStackedAreaSeries;
			series.Brush =	this.CoreBrush.Clone() as StiBrush;
        ...
        public StiStackedAreaSeries()
        {
            this.Core = new StiStackedAreaSeriesCoreXF(this);
        }
	}
}