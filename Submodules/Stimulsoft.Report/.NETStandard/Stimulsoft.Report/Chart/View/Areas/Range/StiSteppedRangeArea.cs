...
{
    public class StiSteppedRangeArea :
        ...
        IStiSteppedRangeArea
    {
        ...
        {
            return typeof(StiSteppedRangeSeries);
        }
        public override Type[] GetSeriesTypes()
        {
            return new[]
            {
                typeof(StiSteppedRangeSeries)
            };
        }
        #endregion
        ...
        [Browsable(false)]
        public override StiComponentId ComponentId => StiComponentId.StiSteppedRangeArea;
        ...
        {
            this.Core = new StiSteppedRangeAreaCoreXF(this);
        }
    }
}
