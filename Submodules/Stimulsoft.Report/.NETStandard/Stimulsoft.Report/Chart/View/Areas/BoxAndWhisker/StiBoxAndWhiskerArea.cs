...
{
    public class StiBoxAndWhiskerArea :
        StiAxisArea,
        IStiBoxAndWhiskerArea
    {
        #region Methods.Types
        public override Type GetDefaultSeriesType()
        {
            return typeof(StiBoxAndWhiskerSeries);
        }
        ...
        [Browsable(false)]
        public override StiComponentId ComponentId => StiComponentId.StiBoxAndWhiskerArea;
        ...
        public override StiPropertyCollection GetProperties(IStiPropertyGrid propertyGrid, StiLevel level)
        {
            ...
            {
                propertyGrid.PropertiesHelper.BoxAndWhiskerArea(),
            });
        ...
        public StiBoxAndWhiskerArea()
        {
            this.Core = new StiBoxAndWhiskerAreaCoreXF(this);
        }
    }
}
