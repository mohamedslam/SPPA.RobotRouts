...
{
    public class StiRadarLineArea :
        StiRadarArea,
        IStiRadarLineArea
    {
        #region IStiPropertyGridObject
        [Browsable(false)]
        public override StiComponentId ComponentId => StiComponentId.StiRadarLineArea;
        ...
        public override StiPropertyCollection GetProperties(IStiPropertyGrid propertyGrid, StiLevel level)
        {
            ...
            {
                propertyGrid.PropertiesHelper.RadarLineArea(),
            });
        ...
        {
            return typeof(StiRadarLineSeries);
        }
        ...
        {
            this.Core = new StiRadarLineAreaCoreXF(this);
        }
    }
}
