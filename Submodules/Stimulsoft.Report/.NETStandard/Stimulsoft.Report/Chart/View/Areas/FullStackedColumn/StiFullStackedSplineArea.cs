...
{
    public class StiFullStackedSplineArea :
        ...
        IStiFullStackedSplineArea
    {
        ...
        {
            return typeof(StiFullStackedSplineSeries);
        }
        #endregion

        #region Methods.override
        [Browsable(false)]
        public override StiComponentId ComponentId => StiComponentId.StiFullStackedSplineArea;
        ...
        {
            this.Core = new StiFullStackedSplineAreaCoreXF(this);
        }
    }
}
