...
namespace Stimulsoft.Report.Chart
{
        ...
        IStiPropertyGridObject
	{
        ...
        public JObject SaveToJsonObject(StiJsonSaveMode mode)
        {
            ...
            jObject.AddPropertyColor("MinorColor", MinorColor, Color.Gainsboro);
        ...
        public void LoadFromJsonObject(JObject jObject)
        {
            foreach (var property in jObject.Properties())
            {
                switch (property.Name)
                {
                    ...
                    case "MinorColor":
                        this.MinorColor = property.DeserializeColor();
                        break;
                    ...
                    case "MinorStyle":
                        this.MinorStyle = property.DeserializeEnum<StiPenStyle>(); 
                        break;
        ...
        [Browsable(false)]
        public StiComponentId ComponentId => StiComponentId.StiGridLines;
		...
		public object Clone()
		{
			var gridLines =	this.MemberwiseClone() as IStiGridLines;
        ...
        public bool IsDefault
        {
            get
            {
                //We especially don't check Color, MinorColor, Style and MinorStyle properties because its default state controls 
        ...
        #region Properties
        [Browsable(false)]
        public StiGridLinesCoreXF Core { get; set; }
        ...
        [StiCategory("Appearance")]
        public Color MinorColor { get; set; } = Color.Gainsboro;

        private bool ShouldSerializeMinorColor()
        {
            return Color != Color.Gainsboro;
        }
        ...
        [StiCategory("Common")]
        public StiPenStyle Style { get; set; } = StiPenStyle.Dot;
        ...
        [StiCategory("Common")]
        public StiPenStyle MinorStyle { get; set; } = StiPenStyle.Dot;
