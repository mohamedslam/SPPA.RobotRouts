...
{
    public class StiStripsYGeom : StiCellGeom
    {
        #region Properties
        ...
        public override void Draw(StiContext context)
        {
            ...
            if (strip.TitleVisible)
            {
                ...
                context.DrawRotatedString(text, font, brush, stripRect, sf, StiRotationMode.CenterCenter, 0, strip.Antialiasing);
            }
        }
        #endregion

        public StiStripsYGeom(IStiStrips strip, RectangleF clientRectangle)
            :
