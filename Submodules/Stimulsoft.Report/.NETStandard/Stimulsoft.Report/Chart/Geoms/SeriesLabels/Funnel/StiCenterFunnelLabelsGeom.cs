...
namespace Stimulsoft.Report.Chart
{
    public class StiCenterFunnelLabelsGeom : StiSeriesLabelsGeom
    {
        ...
        public override void Draw(StiContext context)
        {
            ...
            var rectCurrent = Rectangle.Round(this.ClientRectangle);
        ...
        public StiCenterFunnelLabelsGeom(IStiSeriesLabels seriesLabels, IStiSeries series, int index, double value,
            ...
            StiBrush seriesBrush, StiBrush labelBrush, Color borderColor, Color seriesBorderColor, RectangleF labelRect, StiAnimation animation)
