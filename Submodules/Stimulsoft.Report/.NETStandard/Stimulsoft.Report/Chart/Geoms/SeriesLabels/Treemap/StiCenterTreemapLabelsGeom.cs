...
{
    public class StiCenterTreemapLabelsGeom : StiSeriesLabelsGeom
    {
        #region Properties
        ...
        public StiCenterTreemapLabelsGeom(IStiSeriesLabels seriesLabels, IStiSeries series, int index, double value,
