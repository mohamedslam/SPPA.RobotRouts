...
{
    /// <summary>
    /// Class describes settings for export to XML format.
    /// </summary>
        ...
        StiDataExportSettings
	{
        ...
        public override StiDataType DataType 
        {
            get
            {
                return StiDataType.Xml;
            }
            set
            {
                //throw new ArgumentException("An DataType property of the StiXmlExportSettings class can't be changed!");
            }
        }
        #endregion

        public StiXmlExportSettings()
            : base(StiDataType.Xml)
        {
        }
	}
}
