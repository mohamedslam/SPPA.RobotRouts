    ...
    public class Numbers
    {
        ...
        public static object Add(object a, object b)
        {
            ...
            if (a is IEnumerable<object> || b is IEnumerable<object>)
                return IEnumerableExt.Add(a, b);

            if (ListExt.IsList(a))
                return ListExt.Add(a, b);            
            #endregion
            ...
            switch (typeCodeA)
            {
                ...
                case TypeCode.SByte:
                    switch (typeCodeB)
                    {
                        ...
                        #region Stimulsoft correction
                        case TypeCode.UInt64: return (SByte)a + StiValueHelper.TryToLong(b); //throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'sbyte' and 'ulong'");
                        #endregion
                ...
                case TypeCode.Int16:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.UInt64: return (Int16)a + StiValueHelper.TryToLong(b); //throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'short' and 'ulong'");
                ...
                case TypeCode.Int32:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.UInt64: return (Int32)a + StiValueHelper.TryToLong(b);//throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'int' and 'ulong'");
                ...
                case TypeCode.Int64:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.UInt64: return (Int64)a + StiValueHelper.TryToLong(b);//throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'long' and 'ulong'");
                ...
                case TypeCode.UInt64:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.SByte: return (UInt64)a + StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'ulong' and 'sbyte'");
                        case TypeCode.Int16: return (UInt64)a + StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'ulong' and 'short'");
                        case TypeCode.UInt16: return (UInt64)a + (UInt16)b;
                        case TypeCode.Int32: return (UInt64)a + StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'ulong' and 'int'");
                        case TypeCode.UInt32: return (UInt64)a + (UInt32)b;
                        case TypeCode.Int64: return (UInt64)a + StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '+' can't be applied to operands of types 'ulong' and 'ulong'");
        ...
        public static object Soustract(object a, object b)
        {
            ...
            switch (typeCodeA)
            {
                ...
                case TypeCode.UInt64:
                    ...
                    {
                        case TypeCode.Boolean: throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'ulong' and 'bool'");
                        case TypeCode.SByte: return (UInt64)a - StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'ulong' and 'double'");
                        case TypeCode.Int16: return (UInt64)a - StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'ulong' and 'short'");
                        case TypeCode.UInt16: return (UInt64)a - (UInt16)b;
                        case TypeCode.Int32: return (UInt64)a - StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'ulong' and 'int'");
                        case TypeCode.UInt32: return (UInt64)a - (UInt32)b;
                        case TypeCode.Int64: return (UInt64)a - StiValueHelper.TryToULong(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'ulong' and 'long'");
                        case TypeCode.UInt64: return (UInt64)a - (UInt64)b;
                        case TypeCode.Single: return (UInt64)a - (Single)b;
                        case TypeCode.Double: return (UInt64)a - (Double)b;
                        case TypeCode.Decimal: return (UInt64)a - (Decimal)b;
                ...
                case TypeCode.Single:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.Single: return (Single)a - (Single)b;
                        case TypeCode.Double: return (Single)a - (Double)b;
                        case TypeCode.Decimal: return (Single)a - StiValueHelper.TryToFloat(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'float' and 'decimal'");
                    }
                    break;
                ...
                case TypeCode.Double:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.Single: return (Double)a - (Single)b;
                        case TypeCode.Double: return (Double)a - (Double)b;
                        case TypeCode.Decimal: return (Double)a - StiValueHelper.TryToDouble(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'double' and 'decimal'");
                    }
                    break;
                ...
                case TypeCode.Decimal:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.Int64: return (Decimal)a - (Int64)b;
                        case TypeCode.UInt64: return (Decimal)a - (UInt64)b;
                        case TypeCode.Single: return (Decimal)a - StiValueHelper.TryToDecimal(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'decimal' and 'float'");
                        case TypeCode.Double: return (Decimal)a - StiValueHelper.TryToDecimal(b); //throw new InvalidOperationException("Operator '-' can't be applied to operands of types 'decimal' and 'double'");
                        case TypeCode.Decimal: return (Decimal)a - (Decimal)b;
                    }
                    break;
            }
        ...
        public static object Multiply(object a, object b)
        {
            ...
            #region Stimulsoft correction
            if (a is IEnumerable<object> || b is IEnumerable<object>)
                return IEnumerableExt.Mult(a, b);
            ...
            switch (typeCodeA)
            {
                ...
                case TypeCode.UInt64:
                    ...
                    {
                        case TypeCode.Boolean: throw new InvalidOperationException("Operator '*' can't be applied to operands of types 'ulong' and 'bool'");
                        case TypeCode.SByte: return (Int64)a * StiValueHelper.TryToLong(b); //throw new InvalidOperationException("Operator '*' can't be applied to operands of types 'ulong' and 'sbyte'");
                        case TypeCode.Int16: return (Int64)a * StiValueHelper.TryToLong(b); //throw new InvalidOperationException("Operator '*' can't be applied to operands of types 'ulong' and 'short'");
                        case TypeCode.UInt16: return (UInt64)a * (UInt16)b;
                        case TypeCode.Int32: return (Int64)a * StiValueHelper.TryToLong(b); //throw new InvalidOperationException("Operator '*' can't be applied to operands of types 'ulong' and 'int'");
                        case TypeCode.UInt32: return (UInt64)a * (UInt32)b;
                        case TypeCode.Int64: return (Int64)a * StiValueHelper.TryToLong(b); //throw new InvalidOperationException("Operator '*' can't be applied to operands of types 'ulong' and 'long'");
                        case TypeCode.UInt64: return (UInt64)a * (UInt64)b;
                        case TypeCode.Single: return (UInt64)a * (Single)b;
                        case TypeCode.Double: return (UInt64)a * (Double)b;
                        case TypeCode.Decimal: return (UInt64)a * (Decimal)b;
        ...
        public static object Divide(object a, object b)
        {
            ...
            #region Stimulsoft correction
            if (a is IEnumerable<object> || b is IEnumerable<object>)
                return IEnumerableExt.Div(a, b);
            #endregion

            #region Stimulsoft correction
            if (StiValueHelper.IsZero(b)) return null;
            #endregion
            ...
            switch (typeCodeA)
            {
                ...
                case TypeCode.Decimal:
                    switch (typeCodeB)
                    {
                        ...
                        case TypeCode.UInt64: return (Decimal)a % (UInt64)b;
                        case TypeCode.Single: return (Decimal)a % StiValueHelper.TryToDecimal(b); //throw new InvalidOperationException("Operator '%' can't be applied to operands of types 'decimal' and 'float'");
                        case TypeCode.Double: return (Decimal)a % StiValueHelper.TryToDecimal(b); //throw new InvalidOperationException("Operator '%' can't be applied to operands of types 'decimal' and 'decimal'");
                        case TypeCode.Decimal: return (Decimal)a % (Decimal)b;
                    }
                    break;
            }
