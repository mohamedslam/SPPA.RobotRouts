...
namespace Stimulsoft.Data.Expressions.NCalc.Domain
{
    public class EvaluationVisitor : LogicalExpressionVisitor
    {
        ...
        public object CompareUsingMostPreciseType(object a, object b)
        {
            Type mpt = GetMostPreciseType(a?.GetType(), b?.GetType());

            #region Stimulsoft Correction
            if (ListExt.IsList(a) || ListExt.IsList(b))
                return ListExt.Compare(a, b);
            #endregion

            var value1 = a != null ? Convert.ChangeType(a, mpt) : null;
            var value2 = b != null ? Convert.ChangeType(b, mpt) : null;
        ...
        public override void Visit(BinaryExpression expression)
        {
            ...
            switch (expression.Type)
            {
                ...
                case BinaryExpressionType.Div:
                    #region Stimulsoft correction
                    if (left() is IEnumerable<object> || right() is IEnumerable<object>)
                ...
                case BinaryExpressionType.Equal:
                    ...
                    if (Result is int)
                        Result = (int)Result == 0;
                    if (ListExt.IsList(Result))
                        Result = ListExt.ToList(Result)
                        .Select(v => v is bool ? StiValueHelper.TryToBool(v) : StiValueHelper.TryToInt(v) == 0)
                        .ToList();
                    break;
                ...
                case BinaryExpressionType.BitwiseAnd:
                    ...
                    if (ListExt.IsList(a) || ListExt.IsList(b))
                        Result = IEnumerableExt.BitwiseAnd(a, b);
                    else
                ...
                case BinaryExpressionType.BitwiseOr:
                    ...
                    if (ListExt.IsList(a2) || ListExt.IsList(b2))
                        Result = IEnumerableExt.BitwiseOr(a2, b2);
                    else
                        Result = Convert.ToUInt16(a2) | Convert.ToUInt16(b2);
                    #endregion
                    break;
                ...
                case BinaryExpressionType.BitwiseXOr:
                    ...
                    if (ListExt.IsList(a3) || ListExt.IsList(b3))
                        Result = IEnumerableExt.BitwiseXOr(a3, b3);
                    else
                        Result = Convert.ToUInt16(a3) | Convert.ToUInt16(b3);
                    #endregion
                    break;
        ...
        public override void Visit(UnaryExpression expression)
        {
            ...
            switch (expression.Type)
            {
                case UnaryExpressionType.Not:
                    #region Stimulsoft correction
                    if (ListExt.IsList(Result))
                        Result = IEnumerableExt.BitwiseXOr(Result, 1);
                    else
